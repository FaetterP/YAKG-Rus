...
label d1a1_check_second_room:
    ...
    if not d1a1_upstairs_clue2:
        ...
        scene bg bedroom:
            ...
            easein 3.0 zoom 1.0
        with dissolvemed
        show screen notify_location("2F - The Bedroom", persistent.unlock_bg_bedroom)
...
label d1a1_check_third_room:
    ...
    if not d1a1_upstairs_clue3:
        ...
        with dissolvemed
        pause 2.0
        show screen notify_location("2F - The Empty Bedroom", persistent.unlock_bg_emptybedroom)
...
label d1a1_check_masterbedroom:
    ...
    if not d1a1_visited_masterbedroom:
        ...
        scene bg masterbedroom:
            ...
            easein 3.0 zoom 1.0
        with dissolvemed
        show screen notify_location("2F - The Master Bedroom", persistent.unlock_bg_masterbedroom)
...
label d1a1_check_masterbathroom:
    ...
    if d1a1_masterbedroom_clue4 == False:
        ...
        with dissolve
        pause 1.0
        show screen notify_location("2F - The Master Bathroom", persistent.unlock_bg_masterbathroom)
