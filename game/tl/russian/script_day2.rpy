...
translate russian d2a1_f17d2ead:
    ...
    X "Хммммммм~ [u_music_note]" with hpunch
...
translate russian d2a1_6d0404f0:
    ...
    X "[u_music_note] Хмхммм~ [u_music_note] Хи-хи~ [u_music_note][u_music_note]" with hpunch
...
translate russian d2a1_ca264e27:
    ...
    C towel sad "Аааангх... Хуже всего, что здесь нету моего фена..."

# game/script_day2.rpy:49
translate russian d2a1_f4ddd91f:

    # C "How am I gonna dry all this floof with just a couple of towels..."
    C "Как я собираюсь сушить весь этот пух с помощью только пары полотенец..."
...
translate russian d2a1_c8a03b1d:
    ...
    C towel surprised "Ой! [name_player], ты проснулась!{nw}"
...
translate russian d2a1_a97948ca:
    ...
    Y panicked "Чт-- Сеси?! Ч-что ты делаешь?!" with shakeshort
...
translate russian d2a1_43234a8c:
    ...
    C towel surprised "А? В смысле, я принимала душ, а моя одежда здесь..."
...
translate russian d2a1_9d99bd73:
    ...
    C towel smile "...Подожди, ты завелась из-за того, что видишь меня в полотенце?"

# game/script_day2.rpy:71
translate russian d2a1_33f8292e:

    # Y sad "N-no, I... Uh, tha-that is to say..." with shakeonce
    Y sad "Н-нет, я... Эм, то есть..." with shakeonce
...
translate russian d2a1_472ba845:
    ...
    C towel happy "Ой. Эм. БОЖЕ! Твоё лицо сейчас бесценно! [u_heart]" with hpunch

# game/script_day2.rpy:79
translate russian d2a1_237292cd:

    # C towel smile "If you want, I could give you a closer look...?"
    C towel smile "Если хочешь, я могу дать посмотреть поближе...?"
...
translate russian d2a1_d53a3981:
    ...
    C towel smile "Хи хи, это же лучше, чем раздражающий будильник, верно?"
...
translate russian d2a1_1629dfa5:
    ...
    C towel surprised "Подожди, это всё, что ты хочешь сказать?" with hpunch

# game/script_day2.rpy:105
translate russian d2a1_ab265bdd:

    # Y thinking "...What do you mean? I just woke up."
    Y thinking "...Что ты имеешь в виду? Я только что проснулась."
...
translate russian d2a1_649b646b:
    ...
    C "Чт-- Я имею в виду, у тебя прямо перед глазами почти ГОЛАЯ молодая девушка, ещё и мокрая!" with shakeonce
...
translate russian d2a1_f21b4bac:
    ...
    C towel pout "Это буквально квинтэссенция фансервиса! Возможно, [t_clue]единственная[t_cluee], которую ты получишь!" with shakeonce

# game/script_day2.rpy:108
translate russian d2a1_d3462057:

    # Y worried "...I have no idea what you're talking about..."
    Y worried "...Я не понимаю, о чём ты говоришь..."
...
translate russian d2a1_b947540f:
    ...
    C towel pout "...Подожди, проблема в моих формах? Если бы здесь была Рия, выходящая из душа, твоя реакция была бы лучше?"
...
translate russian d2a1_d5abd7bd:
    ...
    Y surprised "А, да, где Рия? Если она уже проснулась, мне лучше пойти проверить её."
...
translate russian d2a1_861ea64b:
    ...
    C towel pout "АГА, ТО ЕСТЬ ЭТО ПРАВДА! Только кто-то с формами, как у Рии, сможет тебя заинтересовать, да, [name_player]?!" with shakeshort
...
translate russian d2a1_25a8758b:
    ...
    Y worried "Можешь оставить свои шалости и наконец одеться? Мы всё ещё заперты в убийственной игре, как ты знаешь."
...
translate russian d2a1_8f596d42:
    ...
    C "[t_clue]\"Справедливость плоская\"[t_cluee], [name_player]! Заомни это!" with shakeshort
...
translate russian d2a1_a52dee85:
    ...
    Y shouting "Сеси! Ты ХОТЯ БЫ думаешь, что делаешь?!" with shakeshort
...
translate russian d2a1_58958444:
    ...
    C towel pout "ММПХ! Ах! Э-эй, не раскидывай мою одежду!" with shakeshort
...
translate russian d2a1_55a19cdd:
    ...
    C "...Я не предвидела такой поворот событий...{w=1.0} {size=-10}Но это было приятно...{/size} [u_heart]"
...
translate russian d2a1_96fa8bcf:
    ...
    O blink "Ты права, прошло около 8 часов с тех пор, как ты уснула. Ты уже чувствуешь себя лучше?"

# game/script_day2.rpy:187
translate russian d2a1_93c6a154:

    # Y default "I think so. My head isn't aching anymore."
    Y default "Думаю, да. Голова больше не болит."
...
translate russian d2a1_cd9f8fdc:
    ...
    I "Если вычесть пару часов, которые я потратила на объяснение Рии и Сеси, и 8 часов сна..."
...
translate russian d2a1_52cdc46d:
    ...
    I "В конце концов, это 20 часов, но с какого момента? Когда появилось это сообщение? Или когда первая из нас проснулась...?"

# game/script_day2.rpy:203
translate russian d2a1_24df7651:

    # I "Ugh, we really need more information..." with hpunch
    I "Угх, нам действительно нужно больше информации..." with hpunch
...
translate russian d2a1_c0d97e3f:
    ...
    Y thinking "...Ты всё время пристально смотришь на ту дверь. Ты что-то заметила?"

# game/script_day2.rpy:212
translate russian d2a1_d225a20e:

    # Y surprised "Wait... Did you find the [t_clue]key[t_cluee] for it?"
    Y surprised "Подожди... Ты нашла [t_clue]ключ[t_cluee] от неё?"
...
translate russian d2a1_c69acf67:
    ...
    O "Нет, но... Мне пришла в голову мысль, когда я вспомнила, как мы встретили [name_dog]."
...
translate russian d2a1_4998252f:
    ...
    O default "Как он передвигается по дому, если двери закрыты?"

# game/script_day2.rpy:216
translate russian d2a1_443e4a86:

    # Y thinking "Huh... I never thought about that."
    Y thinking "Хм... Я никогда не думала об этом."
...
translate russian d2a1_e2bc4fbd:
    ...
    O sideeye "Так что, следуя этой мысли... Смотри сюда."
...
translate russian d2a1_2073c1d7:
    ...
    O blink "Я думаю, что из нас троих только Сесилия могла бы пролезть через такой маленький проход."
...
translate russian d2a1_3d003c25:
    ...
    Y leering "Имеет смысл. Теперь мы наконец-то можем проверить, что скрывается за этой дверью."
...
translate russian d2a1_ee7facaf:
    ...
    C thinking "Да, но мне приказали спуститься сюда через 2 минуты, так что..."
...
translate russian d2a1_e0a73b0f:
    ...
    I "...Она так странно на меня смотрит..."
...
translate russian d2a1_a0597e18:
    ...
    O annoyed2 "...Да, пожалуй, ты права."
...
translate russian d2a1_98d07c26:
    ...
    C "Сначала моё сердце, а теперь и голова... Почему я должна страдать от такой боли...?" with hpunch

# game/script_day2.rpy:292
translate russian d2a1_12bb00ca:

    # C wink "Heh. You're such a sore loser, Ria..."
    C wink "Хех. Ты такая язвительная, Рия..."
...
translate russian d2a1_0c5a0983:
    ...
    O sideeyeblink "Сесилия. Ты видишь этот маленький проход внизу двери?"
...
translate russian d2a1_eb6ebe39:
    ...
    C sweatdrop "Эээ? Окей, я знаю, что у меня нету такой фигуры, как у вас, но даже МОИ формы застрянут, если попытаться---."

# game/script_day2.rpy:300
translate russian d2a1_de93fe0c:

    # Y thinking "No, from what I saw earlier, I think your body will fit."
    Y thinking "Нет, судя по тому, что я видела раньше, думаю, твое тело поместится."
...
translate russian d2a1_a998642e:
    ...
    C sobbing "[name_player]! Ты понимаешь, что только разбила моё сердце на миллион маленьких кусочков, да?!" with hpunch
...
translate russian d2a1_bf6ff04d:
    ...
    O confused "Слушай, забудь про то, что ты пло--- ...У тебя же есть немного гордости. Объективно, у тебя больше всех шансов пролезть."

# game/script_day2.rpy:304
translate russian d2a1_b8a015b6:

    # C determined "Hey. You were about to say \"flat\", weren't you."
    C determined "Эй. Ты собиралась сказать \"плоская\", не так ли?"
...
translate russian d2a1_577a1f78:
    ...
    Y leering "Должна быть причина, по которой преступник закрыл от нас эту комнату. Единственный шанс выбраться отсюда живыми может быть там."
...
translate russian d2a1_f0a051f6:
    ...
    Y surprised "Там никогда не было никакого замка?"
...
translate russian d2a1_ffc2e1f1:
    ...
    I "Здесь много что разрушено... Интересно, что могло случиться?"
...
translate russian d2a1_3e0467b9:
    ...
    C "ЭЙ! Я могу получить \"спасибо\" за то, что пролезла через эту маленькую щель?!{w=0.5}{nw}" with shakeonce

# game/script_day2.rpy:389
translate russian d2a1_a3334684:

    # extend " My hair's all dirty again!" with shakeshort
    extend " Мои волосы снова грязные!" with shakeshort
...
translate russian d2a1_25043049:
    ...
    C "Ты могла бы остановиться на \"Спасибо, Сеси\"..."
...
translate russian d2a1_0c52b1b5:
    ...
    C default "Помните тот [t_clue]ключ[t_cluee], который, как ты говорила, Рия всегда находила в главной спальне?"

# game/script_day2.rpy:409
translate russian d2a1_147b4f42:

    # Y surprised "Yeah, the one that doesn't open any new doors for us."
    Y surprised "Ага, тот, который не открывает для нас никаких новых дверей."
...
translate russian d2a1_9198542c:
    ...
    C smug "Охохо~ Вот тут ты ошибаешься, моя дорогая [name_player]~"
...
translate russian d2a1_9151b852:
    ...
    C thinking "Так вот, я подумала, что раз Рия говорила, что она нашла ключ внутри шкафа, я решила попробовать и..."
...
translate russian d2a1_b3968848:
    ...
    C happy "Вуаля! Внутри рамы кровати был [t_clue]секретный отсек[t_cluee]! Круто, да?" with vpunch
...
translate russian d2a1_d490fe65:
    ...
    C blink "Это был довольно большой отсек, но там были только какие-то безделушки и [t_clue]длинный шест[t_cluee]."

# game/script_day2.rpy:427
translate russian d2a1_f5d6e624:

    # I "She ignored me..." with hpunch
    I "Она меня проигнорировала..." with hpunch
...
translate russian d2a1_58d0c5b1:
    ...
    C blink "Я дошла до тупика в коридоре на втором этаже и посмотрела вверх на потолок."
...
translate russian d2a1_1d23334a:
    ...
    C default "В темноте немного трудно разглядеть, но там застрял маленький обруч."
...
translate russian d2a1_aa9e2c2b:
    ...
    C smile "Можешь догадаться, что было дальше. Я подняла шест, засунула крючок в этот обруч, и всего лишь дёрнула..."

# game/script_day2.rpy:455
translate russian d2a1_1bd4662d:

    # Y surprised "{cps=6}...An...{/cps} An [t_clue]attic[t_cluee]...?"
    Y surprised "{cps=6}...Это...{/cps} [t_clue]Чердак[t_cluee]...?"
...
translate russian d2a1_c2f0e5ab:
    ...
    C "Точно, моя драгоценная маленькая [name_player]~ И это даже не самая интересная часть!"
...
translate russian d2a1_35b6c4f4:
    ...
    O sideeyeblink "...Для тебя, может и да. Но наша главная задача прямо сейчас - исследовать эту гостиную."

# game/script_day2.rpy:474
translate russian d2a1_425badeb:

    # C surprised "Wha--{w=0.5}{nw}"
    C surprised "Чт--{w=0.5}{nw}"

# game/script_day2.rpy:477
translate russian d2a1_ac890204:

    # extend " WHAAAAT?! You guys don't want to check it out?! [name_player]?!"
    extend "ЧТОООО?! Вы, ребята, не хотите это всё проверить?! [name_player]?! " with vpunch
...
translate russian d2a1_ba8a16c1:
    ...
    Y thinking "Не знаю... Насколько важной может быть куча оккультных штук?"
...
translate russian d2a1_2d1a0bac:
    ...
    C "Но вы же сами говорили! Если комната была закрыта для нас..." with hpunch
...
translate russian d2a1_a4849ba2:
    ...
    C "Должна быть какая-то [t_clue]причина[t_cluee], почему преступник не хочет, чтобы мы туда зашли!"

# game/script_day2.rpy:483
translate russian d2a1_0c1241c5:

    # Y surprised "...That's a good point."
    Y surprised "...Это хороший аргумент."
...
translate russian d2a1_4a58efad:
    ...
    Y thinking "Рия, ты должна признать, что чердак теперь выглядит не менее подозрительно, чем эта гостиная, если не более."
...
translate russian d2a1_74ff4cea:
    ...
    C grin "Ох! Точно, Рия, ты не слишком любишь всякие жуткие штуки, не так ли?"
...
translate russian d2a1_dc52ded5:
    ...
    O annoyed2 "Меня такое не пугает, если ты намекаешь на это. Просто раздражает, как люди верят в такую нелогичную чепуху."
...
translate russian d2a1_3625d53e:
    ...
    O irritated "У нас нет времени на погоню за сказками. Нам лучше остаться здесь и узнать больше о преступнике."
...
translate russian d2a1_642c0abd:
    ...
    C blink "Ладно, ладно, иди проверяй свою скучную гостиную. Однако, {i}я{/i} не могу устоять перед привлекательностью оккультизма."

# game/script_day2.rpy:494
translate russian d2a1_f82bd85c:

    # C "[name_player], come with me!"
    C "[name_player], пошли со мной!"
...
translate russian d2a1_39d8fab7:
    ...
    I "...Похоже, больше негде проверять, кроме [t_clue]чердака[t_cluee] или [t_clue]гостиной[t_cluee]..."
...
translate russian d2a1_19be91cd:
    ...
    I "А если они собираются разделиться, мне нужно выбрать, с кем пойти..."
...
translate russian d2a1_start_investigation_5be7c2bf:
    ...
    extend irritated " *кхм* ...Не недооценяй меня. Я уже несколько раз осматривала этот дом одна." with hpunch
...
translate russian d2a1_start_investigation_a3d5e15a:
    ...
    C grin "Да, но это новая комната. А сумасшедший преступник может быть где угооооодноооо~"

# game/script_day2.rpy:517
translate russian d2a1_start_investigation_05cb661e:

    # Y worried "C-come on, Cece, don't do that..."
    Y worried "Л-ладно, Сеси, не говори так..."
...
translate russian d2a1_start_investigation_a7ec8435:
    ...
    O irritated "Ну... Эм..." with shakeonce
...
translate russian d2a1_start_investigation_9e4ccc7c:
    ...
    Y happy "Д-да, конечно!" with vpunch
...
translate russian d2a1_start_investigation_fac2f6a7:
    ...
    I "...Что-то не так. Где-то в глубине души мне подсказывает, что..."
...
translate russian d2a1_start_investigation_46f5a8bc:
    ...
    I "...если я пойду на чердак с Сеси, [t_clue]с Рией что-то случится[t_cluee]..."
...
translate russian d2a1_start_investigation_6a2152c5:
    ...
    I "...Похоже, у меня есть только один выбор."
...
translate russian d2a1_start_investigation_6337ed8b:
    ...
    Y blink "...Извини, Сеси. Думаю, я останусь здесь и помогу Рии."
...
translate russian d2a1_start_investigation_754ab145:
    ...
    O default "...Спасибо, [name_player]. Я ценю это."
...
translate russian d2a1_start_investigation_a9f3e1ca:
    ...
    C surprised "Подожди, серьёзно?! Ранее ты так сильно краснела. Я думала, что точно завоевала твоё сердце!"
...
translate russian d2a1_start_investigation_94ed2016:
    ...
    C thinking "...А, наверное, ты из тех, кто быстро теряет интерес к девушке и переходит к следующей жертве, не так ли?"
...
translate russian d2a1_start_investigation_cd30c173:
    ...
    C "Похоже, мне действительно не конкурировать с Рией, а...?"
...
translate russian d2a1_start_investigation_de73f595:
    ...
    Y worried "Это не то, почему я стою здесь."
...
translate russian d2a1_start_investigation_2b84d902:
    ...
    O irritated2 "Сесилия. Перестань тратить время и иди искать улики на чердаке."
...
translate russian d2a1_start_investigation_f45d1823:
    ...
    C "...Рия... Ты... Ты что, говоришь, что [t_clue]веришь[t_cluee] в меня?"
...
translate russian d2a1_start_investigation_60c30c3e:
    ...
    C happy "Я найду для нас [t_clue]самую важную улику[t_cluee], которую вы когда-либо видели!"
...
translate russian d2a1_start_investigation_d5d2af0c:
    ...
    I "...если я останусь здесь с Рией, [t_clue]с Сеси что-то случится[t_cluee]..."
...
translate russian d2a1_attic_b23eda52:
    ...
    Y surprised "Хм, тут действительно {i}есть{/i} чердак. Неудивительно, что этот уголок казался немного странным."
...
translate russian d2a1_attic_f00221ba:
    ...
    C wink "...Ах. Только не смотри слишком пристально на мои ягодицы, ладно?"
...
translate russian d2a1_attic_a7af916a:
    ...
    I "Не похоже, что мы сможем выбраться из этой убийственной игры с помощью магии..."
...
translate russian d2a1_attic_a9e5a765:
    ...
    C blink "Ну, ты уже сделала выбор и поднялась сюда. Посмотреть не помешает, верно? К тому же..."
...
translate russian d2a1_attic_7d81ebc6:
    ...
    C smile "Возможно, здесь мы можем узнать что-то о том, что вызывает твои [t_clue]путешествия во времени[t_cluee]."

# game/script_day2.rpy:732
translate russian d2a1_attic_ca60d538:

    # Y surprised "...! That's true..." with shakeonce
    Y surprised "...! Это правда..." with shakeonce
...
translate russian d2a1_attic_42f88265:
    ...
    C happy "Давай, иди и посмотри на всё, что выглядит интересным! Я буду прямо за тобой, готовая прокомментировать что угодно!"
...
translate russian d2a1_attic_c2f1ee4a:
    ...
    I "Или ты можешь...знаешь, провести собственное расследование?" with hpunch
...
translate russian d2a1_attic_end_4ad1e855:
    ...
    C "Ну? Какие-нибудь идеи пришли в голову? Поделись со всем классом~"
...
translate russian d2a1_attic_end_074c7979:
    ...
    Y default "Что-то мне подсказывает, что тот, кто собрал все эти вещи, пытался [t_clue]достигнуть конкретной цели[t_cluee]."
...
translate russian d2a1_attic_end_28724f35:
    ...
    C smug "Очень проницательно, [name_player]! Ты получаешь пятерку с плюсом!"
...
translate russian d2a1_attic_end_f54c8966:
    ...
    C surprised "Ох, я пришла к такому же выводу, как и ты."
...
translate russian d2a1_attic_end_d7050892:
    ...
    C thinking "Если владелец этих книг был энтузиастом оккультизма, как я, то тут было бы больше разнообразных тем."
...
translate russian d2a1_attic_end_3435fb6b:
    ...
    C "Магические круги, например, часто используют для благословения предметов или вызова демонов, а тут нет ни одной книги на эту тему."
...
translate russian d2a1_attic_end_6c028693:
    ...
    Y default "Предсказание или изменение судьбы - это часть оккультизма, верно?"
...
translate russian d2a1_attic_end_73f2e804:
    ...
    Y "Ты знаешь какие-нибудь ритуалы, с помощью которых мы могли бы заглянуть в будущее? Хотя бы на немного вперёд?"

# game/script_day2.rpy:843
translate russian d2a1_attic_end_31ef759d:

    # C surprised "You mean like fortune telling? Hmm..."
    C surprised "Ты имеешь в виду что-то вроде гадания? Хмм..."
...
translate russian d2a1_attic_end_37d5b3f6:
    ...
    C thinking "...Честно говоря, такие вещи обычно предназначены больше для развлечения, чем для спасения жизни..."

# game/script_day2.rpy:845
translate russian d2a1_attic_end_d0f4bb7b:

    # Y leering "But anything helps, right?"
    Y leering "Но что-то ведь поможет, правда?"
...
translate russian d2a1_attic_end_ad27b233:
    ...
    C sweatdrop "Прости, [name_player], но даже если бы мы захотели погадать..."
...
translate russian d2a1_attic_end_28b34899:
    ...
    C sad "...для тех способов, которые я знаю наизусть, у нас нет подходящих материалов."
...
translate russian d2a1_attic_end_db36e27f:
    ...
    C "И как ты знаешь, ни одна из этих книг не имеет отношения к чему-то, кроме мёртвых людей."
...
translate russian d2a1_attic_end_94892c50:
    ...
    C smile "Но подожди, не забудь, [name_player], ты же [t_clue]путешественник во времени[t_cluee], не так ли?"
...
translate russian d2a1_attic_end_e814a461:
    ...
    C "Возвращение в прошлое с знанием будущего - это, как бы, высшая форма гадания!"
...
translate russian d2a1_attic_end_bc47ee05:
    ...
    Y wince "Наверное... Просто жаль, что мои воспоминания о будущем не такие чёткие..."
...
translate russian d2a1_attic_end_bd7747ce:
    ...
    I "Если бы я только могла должным образом освоить эту свою силу, то..."
...
translate russian d2a1_attic_end_bb5cbce7:
    ...
    Y panicked "...Чт... Подожди, это был звук...?" with shakeonce
...
translate russian d2a1_attic_end_36bfbffa:
    ...
    C thinking "[name_player], нам стоит спуститься вниз и проверить."
...
translate russian d2a1_attic_end_f66f2944:
    ...
    Y "...Тогда...это значит..." with shakeonce
...
translate russian d2a1_attic_end_ca2d86eb:
    ...
    I "...! Она... Она просто на диване..." with shakeonce
...
translate russian d2a1_attic_end_66d04c05:
    ...
    C blink "...Значит, это действительно произошло."
...
translate russian d2a1_attic_end_5be2d681:
    ...
    C blink "[name_player], я хочу, чтобы ты успокоилась и выслушала меня."
...
translate russian d2a1_attic_end_0149c15e:
    ...
    Y afraid "Ч-что? \"Успокоилась\"...? Как я должна это сделать?!" with shakeonce
...
translate russian d2a1_attic_end_e9f5594a:
    ...
    Y pained "Рия была жива ещё менее часа назад!" with shakeonce
...
translate russian d2a1_attic_end_8b55a31b:
    ...
    C "Ты и я были в чердаке вместе всё это время. Ни одна из нас не могла этого сделать."

# game/script_day2.rpy:1000
translate russian d2a1_attic_end_fe996051:

    # C default "So...what does that mean?{nw}"
    C default "Так...что это значит?{nw}"
...
translate russian d2a1_attic_end_1c44ad8c:
    ...
    Y troubled "Она...убила себя... да? Потому что всё это было слишком..."
...
translate russian d2a1_attic_end_bfa48158:
    ...
    C sad "[name_player]. Мы обе знаем, что она никогда бы этого не сделала."
...
translate russian d2a1_attic_end_0439d58f:
    ...
    C thinking "Давай, это не так сложно. Подумай об этом."
...
translate russian d2a1_attic_end_51206869:
    ...
    C thinking "Нигде нету оружия, которым убили Рию."
...
translate russian d2a1_attic_end_45a1fcea:
    ...
    C "Другими словами, [name_player], преступник, вероятно, не сбежал через фойе."
...
translate russian d2a1_attic_end_436a5e1c:
    ...
    C determined "Он всё ещё может прятаться здесь, ожидая, чтобы убить нас тоже."
...
translate russian d2a1_attic_end_d827db53:
    ...
    C determined "Нам нужно бежать. Или идти за помощью. Мы не сможем справиться с убийцей вдвоём."

# game/script_day2.rpy:1030
translate russian d2a1_attic_end_ae39a052:

    # Y scream "STOP BEING THE RATIONAL ONE!!" with shakeshort
    Y scream "ПРЕКРАТИ БЫТЬ РАЦИОНАЛЬНОЙ!!" with shakeshort
...
translate russian d2a1_attic_end_1183ed4c:
    ...
    Y pained "Рия... Рия была твоей подругой, разве нет...?" with shakeonce

# game/script_day2.rpy:1034
translate russian d2a1_attic_end_1cc5d849:

    # Y "How can you be so cold about her death...?"
    Y "Как ты можешь быть такой холодной по поводу её смерти...?"
...
translate russian d2a1_attic_end_dc8e4ee9:
    ...
    Y depressed "...Рия... Мы не можем оставить...Рию..."
...
translate russian d2a1_attic_end_a68930ae:
    ...
    KI "[t_ghost]...Я не могу позволить Рии... умереть так... Это...[t_ghoste]" with shakeonce
...
translate russian d2a1_attic_end_44f0728b:
    ...
    C determined "[name_player], быстро! Прежде чем уйдёшь, просто постарайся изо всех сил запомнить это предложение!"
...
translate russian d2a1_attic_end_656c2962:
    ...
    C default "[t_clue]Серена убила рыбу-клоуна.[t_cluee]"
...
translate russian d2a1_attic_end_0de32b05:
    ...
    C smile "Просто запомни это, окей?! Я--{w=0.2}{nw}"
...
translate russian d2a1_lounge_96381da6:
    ...
    O "...Ей действительно нужен переключатель громкости..."
...
translate russian d2a1_lounge_249aca42:
    ...
    Y confused "Ахах... Она всегда так переживает из-за всего, что связано с оккультизмом?"
...
translate russian d2a1_lounge_d823135f:
    ...
    O leering "Да. У неё непревзойдёный энтузиазм по поводу всего жуткого и потустороннего."
...
translate russian d2a1_lounge_1f968f2e:
    ...
    O sideeyeblink "Честно говоря, не важно, как сильно ты что-то любишь, нужно хотя бы пытаться вести себя по-взрослому."

# game/script_day2.rpy:1100
translate russian d2a1_lounge_25cec94c:

    # Y surprised "Oh. It's [name_dog]."
    Y surprised "Ой. Это [name_dog]."

# game/script_day2.rpy:1104
translate russian d2a1_lounge_9ddc55cf:

    # O panicked "WHAT?! WHERE?! AHH!!" with shakeshort
    O panicked "ЧТО?! ГДЕ?! ААА!!" with shakeshort

# game/script_day2.rpy:1113
translate russian d2a1_lounge_ff75ecfd:
    ...
    O overjoyed "ВОТ ТЫ ГДЕЕЕЕ!! Я искала тебя ПОВСЮДУ, маленький [name_dog]!" with hpunch

# game/script_day2.rpy:1115
...
translate russian d2a1_lounge_288c0ade:
    ...
    O panicked "Ах! Подожди! [name_dog], вернииииись!" with shakeonce
...
translate russian d2a1_lounge_1c01b3a9:
    ...
    I "...Рия та ещё штучка, не правда ли."

# game/script_day2.rpy:1205
translate russian d2a1_lounge_end_c7b72886:

    # Y "Okay, looks like that's everything covered."
    Y "Хорошо, похоже, мы всё осмотрели."
...
translate russian d2a1_lounge_end_4d4d5b44:
    ...
    I "Она всё ещё переживает из-за того, что этот пёс её бросил..." with hpunch
...
translate russian d2a1_lounge_end_b458b2ca:
    ...
    Y leering "Давай, Рия, соберись! Что мы узнали, осматривая эту комнату?" with shakeonce
...
translate russian d2a1_lounge_end_003bf4fd:
    ...
    O "...Здесь раньше жила [t_clue]семья[t_cluee]. И их разделила ужасная трагедия."

# game/script_day2.rpy:1219
translate russian d2a1_lounge_end_059419cc:

    # Y relaxed "Very good! And what else?"
    Y relaxed "Очень хорошо! А что ещё?"

# game/script_day2.rpy:1220
translate russian d2a1_lounge_end_380cd5ee:
    ...
    O "...Есть дверь, ведущая в [t_clue]подвал[t_cluee]... Но нам стоит вернуться за Сесилией, прежде чем идти туда."

# game/script_day2.rpy:1222
translate russian d2a1_lounge_end_6c35e428:

    # Y happy "Exactly! Very well done!" with vpunch
    Y happy "Именно! Очень хорошо!" with vpunch
...
translate russian d2a1_lounge_end_d1ece83a:
    ...
    Y worried "Верно, прости." with hpunch
...
translate russian d2a1_lounge_end_86c934a0:
    ...
    O sideeye "...[name_player], ты помнишь, в каком состоянии были спальни наверху?"
...
translate russian d2a1_lounge_end_9e457c96:
    ...
    O blink "Мы знаем, что одна из спален принадлежала маленькой девочке. Наверное, младшей дочери этой семьи."
...
translate russian d2a1_lounge_end_8622f4aa:
    ...
    O "В главной спальне только мужская одежда, а вот загадочная пустая спальня..."

# game/script_day2.rpy:1230
translate russian d2a1_lounge_end_4d7c616a:

    # Y thinking "Uh huh...?"
    Y thinking "Эм...?"

# game/script_day2.rpy:1233
...
translate russian d2a1_lounge_tragedy_269ffc3a:
    ...
    Y thinking "Родители развелись, верно? Это объясняет, почему в главной спальне только мужская одежда."
...
translate russian d2a1_lounge_tragedy_8a6b8292:
    ...
    Y default "Мать, должно быть, покинула дом и забрала с собой сына."
...
translate russian d2a1_lounge_tragedy_e8f1028d:
    ...
    O blink "...Я полагаю, это не худшее предположение."
...
translate russian d2a1_lounge_tragedy_b7bb8a49:
    ...
    O thinking "Честно говоря, я бы хотела, чтобы трагедия была настолько простой и бескровной..."
...
translate russian d2a1_lounge_tragedy_f253193d:
    ...
    O default "Нет. Мать, безусловно, оставила отца, скорее всего, забрав с собой сына..."
...
translate russian d2a1_lounge_tragedy_1dd7f499:
    ...
    O sideeyeblink "Но до этого должно было быть что-то ещё. Что-то большое."
...
translate russian d2a1_lounge_tragedy_0417b4dc:
    ...
    I "Почему она не может просто сказать, в чём дело, вместо того, чтобы раздувать это...?" with hpunch
...
translate russian d2a1_lounge_tragedy_d487b524:
    ...
    Y default "Сын умер, верно? Пустая спальня, должно быть, принадлежала ему."
...
translate russian d2a1_lounge_tragedy_f552630c:
    ...
    Y sad "А потом, после его смерти, семья, должно быть, убрала его спальню, чтобы забыть боль утраты."
...
translate russian d2a1_lounge_tragedy_30c9048d:
    ...
    O sideeyeblink "...[name_player], ты так близка, но так, ТАК далека."
...
translate russian d2a1_lounge_tragedy_e8db26c1:
    ...
    O sideeye "Ты помнишь письмо матери, где она упоминает, что сын с ней, да?"
...
translate russian d2a1_lounge_tragedy_d9d0cadd:
    ...
    O sideeyeblink "Кроме того, если бы сын действительно умер, я не думаю, что они бы убрали его спальню."
...
translate russian d2a1_lounge_tragedy_ab0ff013:
    ...
    O thinking "В любом случае, они бы [t_clue]сохранили[t_cluee] всё, но она была полностью вычищена. Это почти злобно."
...
translate russian d2a1_lounge_tragedy_07c4059d:
    ...
    O default "Ты почти справилась. Сейчас должно быть очевидно, что произошло."
...
translate russian d2a1_lounge_tragedy_aaf37228:
    ...
    I "Тогда, может, ты просто скажешь мне ответ?" with hpunch

# game/script_day2.rpy:1264
translate russian d2a1_lounge_tragedy_db819b4b:

    # Y blink "The daughter died, right?"
    Y blink "Дочь умерла, верно?"

# game/script_day2.rpy:1266
translate russian d2a1_lounge_tragedy_e04e69a8:
    ...
    Y default "Наверное, поэтому спальня маленькой девочки была оставлена в порядке."
...
translate russian d2a1_lounge_tragedy_201786fa:
    ...
    O blink "...Я тоже так думаю, но очевидно, что этого недостаточно как доказательства."

# game/script_day2.rpy:1269
translate russian d2a1_lounge_tragedy_846577c1:

    # O leering2 "What else did we learn that suggests the daughter died?{nw}"
    O leering2 "Что ещё мы узнали, что подтверждает, что дочь умерла?{nw}"
...
translate russian d2a1_lounge_tragedy_3ee0bea4:
    ...
    Y thinking "Это беспокоило меня всё это время, но почему сын и мать так долго ждали, прежде чем уехать?"
...
translate russian d2a1_lounge_tragedy_df721148:
    ...
    Y leering "Если это правда, что отец избивал сына, то почему они не отреагировали раньше? В самом деле, почему они не обратились в полицию?" with shakeonce
...
translate russian d2a1_lounge_tragedy_a1012dbb:
    ...
    O thinking "[name_player], домашнее насилие всегда было сложной проблемой. Жертвы не могут быть объективными в таких ситуациях."
...
translate russian d2a1_lounge_tragedy_7f169205:
    ...
    O default "Может быть множество причин, почему они оставались так долго, и почему не позвали за помощью."
...
translate russian d2a1_lounge_tragedy_658ae5b4:
    ...
    O blink "Вот почему только их действия не обязательно доказывают, что дочь умерла."
...
translate russian d2a1_lounge_tragedy_ac8b69a2:
    ...
    O "Просто чтобы прояснить, давай начнём с самого начала."
...
translate russian d2a1_lounge_tragedy_1fa4a356:
    ...
    Y blink "Я заметила кое-что странное в содержимом письма."
...
translate russian d2a1_lounge_tragedy_13863ad9:
    ...
    Y worried "Я, эм... не знаю." with hpunch
...
translate russian d2a1_lounge_tragedy_c2a78e26:
    ...
    Y thinking "Может быть, мы немного ошиблись в наших предположениях...?"
...
translate russian d2a1_lounge_tragedy_0c665e6f:
    ...
    O confused "...Ладно, давай обдумаем это с самого начала снова."
...
translate russian d2a1_lounge_tragedy_fdf887f4:
    ...
    O "Узнав о смерти дочери и о том, как это повлияло на её близких... У тебя есть какие-то чувства по этому поводу?"
...
translate russian d2a1_lounge_tragedy_e04d2349:
    ...
    Y sad "Чувства...? Я имею в виду, это трагедия, без сомнения. Я им соболезную."
...
translate russian d2a1_lounge_tragedy_5b28027b:
    ...
    Y default "Но [t_clue]я не знаю этих людей[t_cluee]. Или, по крайней мере...не думаю, что знаю."
...
translate russian d2a1_lounge_tragedy_2a4c95c1:
    ...
    O blink "...Поняла. Тогда оставим всё так."
...
translate russian d2a1_lounge_tragedy_56aba764:
    ...
    O leering2 "Другими словами, [t_clue]отец является организатором[t_cluee] этой убийственной игры."
...
translate russian d2a1_lounge_tragedy_355b7a2f:
    ...
    Y sad "Но... Я не знаю, есть куча доказательств того, что до трагедии он был хорошим отцом."
...
translate russian d2a1_lounge_tragedy_4c646077:
    ...
    extend irritated "Нет." with shakeonce
...
translate russian d2a1_lounge_tragedy_15029e90:
    ...
    O annoyed2 "Преступник остаётся преступником, независимо от обстоятельств."
...
translate russian d2a1_lounge_tragedy_48e2563d:
    ...
    O leering2 "Никакие страдания не могут оправдать то, что он сделал со своим сыном. ...И что он сделал с нами."
...
translate russian d2a1_lounge_tragedy_bffb1959:
    ...
    O thinking "Он, скорее всего, прячется в [t_clue]подвале[t_cluee]. Нам нужно найти Сесилию и подготовиться, чтобы совершить правосудие."
...
translate russian d2a1_lounge_tragedy_0b44bb81:
    ...
    I "Должно быть, она полностью увлеклась тем, что нашла на чердаке. Интересно, нашла ли она что-то важное..."
...
translate russian d2a1_lounge_tragedy_b9913353:
    ...
    Y surprised "Хах, кто бы мог подумать, здесь и правда есть чердак. Неудивительно, что этот уголок казался немного странным."
...
translate russian d2a1_lounge_tragedy_6e874dfc:
    ...
    Y default "Эй! Сеси! Ты уже закончила осматривать чердак?"
...
translate russian d2a1_lounge_tragedy_86d9ce6f:
    ...
    Y shouting "СЕСИ! ДАВАЙ ЖЕ, НАМ НУЖНО ОСМОТРЕТЬ ЕЩЁ ОДНО МЕСТО! СПУСКАЙСЯ!" with shakelong
...
translate russian d2a1_lounge_tragedy_21af2c8e:
    ...
    Y default "Ты можешь подождать здесь, Рия. Я быстро её спущу."
...
translate russian d2a1_lounge_tragedy_d622ed48:
    ...
    O thinking "О-ох, ладно, не торопись..."
...
translate russian d2a1_lounge_tragedy_442e951f:
    ...
    I "Все сегодня такие рассеянные..."
...
translate russian d2a1_lounge_tragedy_4203ebb2:
    ...
    Y scream "Сеси, поговори со мной!" with shakeshort
...
translate russian d2a1_lounge_tragedy_2ffbe8a8:
    ...
    Y troubled "Все в порядке, Сеси! С тобой всё будет хорошо! Просто... Просто сосредоточься на дыхании!" with shakeonce
...
translate russian d2a1_lounge_tragedy_199632e7:
    ...
    Y "Нужно что-нибудь, чтобы остановить кровотечение...! Должно быть что-то... Что угодно!" with shakeonce
...
translate russian d2a1_lounge_tragedy_c857e1df:
    ...
    C "Не...надо... [name_player]... Я...не...оправлюсь...от этого..."
...
translate russian d2a1_lounge_tragedy_b6e09be6:
    ...
    Y pained "Хватит шутить! Это... Это единственный раз, когда тебе не следует шутить!" with shakeshort

# game/script_day2.rpy:1440
translate russian d2a1_lounge_tragedy_e51a6c6a:

    # C "I...know... It's...no joke..."
    C "Я...знаю... Это...не шутка..."
...
translate russian d2a1_lounge_tragedy_8be3e89f:
    ...
    Y angry "Кто это сделал с тобой?! Сеси! Ты видела преступника?!"
...
translate russian d2a1_lounge_tragedy_05fdce55:
    ...
    C "[t_clue]Страница[t_cluee]... [t_clue]Сорок[t_cluee]... {size=-10}[t_clue]Че[t_cluee]...{/size}"

# game/script_day2.rpy:1462
translate russian d2a1_lounge_tragedy_1570094d:

    # Y shocked "{cps=6}.....{/cps} ...C-Cece...?"
    Y shocked "{cps=6}.....{/cps} ...С-Сеси...?"
...
translate russian d2a1_lounge_tragedy_6250cde8:
    ...
    O irritated "...[name_player]. Она всё."
...
translate russian d2a1_lounge_tragedy_f11b8e76:
    ...
    O "Сесилия... {w=1.0}{cps=9}[t_clue]мертва[t_cluee].{/cps}{nw}"
...
translate russian d2a1_lounge_tragedy_d2556ff1:
    ...
    O thinking "У нее две глубокие ножевые раны: одна на животе и одна на шее..."
...
translate russian d2a1_lounge_tragedy_5a5b0fe3:
    ...
    O sideeye "Её кухонный нож лежит на полу рядом с ней. Крови нет."
...
translate russian d2a1_lounge_tragedy_d09b3e61:
    ...
    O leering "Это значит, что кто-то использовал [t_clue]другой нож[t_cluee], чтобы убить её."

# game/script_day2.rpy:1486
translate russian d2a1_lounge_tragedy_27d2a107:

    # Y "...Not \"someone\". A [t_clue]demon[t_cluee]."
    Y "...Не \"кто-то\". А [t_clue]демон[t_cluee]."
...
translate russian d2a1_lounge_tragedy_d46b53a8:
    ...
    Y shadow2 "Но это единственное, что имеет смысл..."
...
translate russian d2a1_lounge_tragedy_c138c636:
    ...
    Y happy "...Хех... Хех хех... Это идеально подходит..." with shakeonce
...
translate russian d2a1_lounge_tragedy_14a5aba2:
    ...
    O shouting "[name_player]! Забудь обо всём этом! Нам нужно уходить! СЕЙЧАС!" with shakeshort
...
translate russian d2a1_lounge_tragedy_f7dd6b11:
    ...
    O leering "Смерть Сеси означает, что входная дверь открыта. Мы обе это слышали даже отсюда!"

# game/script_day2.rpy:1497
translate russian d2a1_lounge_tragedy_ca0b9280:

    # Y troubled "Nrgh..." with shakeonce
    Y troubled "Нргх..." with shakeonce
...
translate russian d2a1_lounge_tragedy_97228f27:
    ...
    O annoyed2 "Мы не знаем, кто её убил! Демон или нет, но он всё ещё может прятаться где-то здесь!"
...
translate russian d2a1_lounge_tragedy_1daecb61:
    ...
    O shouting "Мы обязаны ей, что можем выбраться отсюда живыми! Не сделай её [t_clue]жертву[t_cluee] напрасной!" with shakeshort

# game/script_day2.rpy:1500
translate russian d2a1_lounge_tragedy_a746113f:

    # Y depressed "Demon... Sacrifice..."
    Y depressed "Демон... Жертва..."
...
translate russian d2a1_lounge_tragedy_2e301e7f:
    ...
    extend " П-подожди, ты имеешь в виду свою способность [t_clue]перемещаться во времени[t_cluee]?!" with shakeonce

# game/script_day2.rpy:1516
translate russian d2a1_lounge_tragedy_e7f3966d:

    # KI "[t_ghost]...Cece can't...[t_ghoste]"
    KI "[t_ghost]...Сеси не может...[t_ghoste]"
...
translate russian d2a1_lounge_tragedy_bf75d193:
    ...
    O horrified "Нет! Стой! [name_player]! Не поворачивай время вспять!" with shakeonce
...
translate russian d2a1_lounge_tragedy_dc8627dc:
    ...
    Y "...Сеси... Сеси...не заслуживает этого..."
...
translate russian d2a1_lounge_tragedy_bbd2b80c:
    ...
    KI "[t_ghost]...Мы не можем оставить все... так... [t_ghoste]"
...
translate russian d2a1_lounge_tragedy_41a1f6db:
    ...
    KI "[t_ghost]{size=+5}ВОЗВРАЩАЙСЯ НАЗААААААААААААААД!!!{/size}[t_ghoste]" with shakelong
...
translate russian d2a2_9475688a:
    ...
    extend pained2 "...либо ты..." with shakeonce

# game/script_day2.rpy:1679
translate russian d2a2_c61fbc03:

    # Y pained "It's... It's my fault... It's because I left you alone, and..."
    Y pained "Это... Это моя вина... Это потому, что я оставила тебя одну, и..."

# game/script_day2.rpy:1681
...
translate russian d2a2_27a79dc6:
    ...
    O "У нас нет времени, чтобы ты вот так разваливалась на части."
...
translate russian d2a2_2ef17122:
    ...
    C surprised "Вот, смотри, что ты наделала! [name_player] теперь застыла!"
...
translate russian d2a2_9e0c0a2c:
    ...
    O sideeyeblink "...Неважно, что случилось в будущем, откуда ты пришла, факт в том, что сейчас ты здесь."
...
translate russian d2a2_62e742e5:
    ...
    O sideeye "Мы обе ещё живы прямо СЕЙЧАС и готовы услышать информацию, которая у тебя есть, [name_player]."

# game/script_day2.rpy:1694
translate russian d2a2_605e1214:

    # Y surprised "...!" with shakeonce
    Y surprised "...!" with shakeonce

# game/script_day2.rpy:1695
...
translate russian d2a2_c6a5ff85:
    ...
    C "Ага, что {i}она{/i} сказала! Мы рассчитываем на тебя, [name_player]!"
...
translate russian d2a2_0fe88198:
    ...
    O "Так что, когда кто-то из нас решает исследовать своё место в одиночку, нас убивает [t_clue]неизвестный нападающий[t_cluee]."
...
translate russian d2a2_161bf656:
    ...
    C default "Полагаю, это значит, что преступник понял, что мы больше не участвуем в его убийственной игре?"
...
translate russian d2a2_8c6d9e97:
    ...
    O thinking "А чердак и гостиная - это места, куда преступник никак не ожидал, что мы сможем попасть."
...
translate russian d2a2_c22d9d07:
    ...
    O default "Возможно, в этих местах есть важная информация, которая может раскрыть преступника."
...
translate russian d2a2_a34c8916:
    ...
    C smile "Что ещё ты помнишь об этой странице, [name_player]?"

# game/script_day2.rpy:1722
translate russian d2a2_02693565:
    ...
    Y thinking "Немного... Я помню только название страницы, как оно было обведено красным, и много текста и изображений, которые я не смогла понять."
...
translate russian d2a2_c057a642:
    ...
    O sideeye "Нам троим нужно держаться вместе и отправиться в [t_clue]подвал[t_cluee]."
...
translate russian d2a2_6b9a55bd:
    ...
    C smile "Время для {color=#ff0000}финального босса{/color}, а...? Думаете, у нас есть шанс победить?"

# game/script_day2.rpy:1729
translate russian d2a2_2847143e:
    ...
    O thinking "Слишком рано говорить наверняка. Мы знаем, что это, скорее всего, [t_clue]отец семьи[t_cluee], который жил в этом доме."
...
translate russian d2a2_4379fc80:
    ...
    O default "Учитывая то, что мы узнали о нём из [t_clue]письма матери[t_cluee], он, вероятно, нестабильный и жестокий."
...
translate russian d2a2_6489f103:
    ...
    C blink knife "Ох, пф, это не то, с чем я и мой нож не справимся!" with hpunch
...
translate russian d2a2_696fe3fc:
    ...
    O leering "Ты уже забыла, что [name_player] видела, как ты умерла на чердаке?"

# game/script_day2.rpy:1734
translate russian d2a2_3159246e:

    # C sweatdrop "Geh-- I-I mean..." with hpunch
    C sweatdrop "Гх-- Я-Я имела в виду..." with hpunch

# game/script_day2.rpy:1735
...
translate russian d2a2_ee07f99d:
    ...
    Y default "Если случится худшее, я всегда могу вернуться назад во времени, верно?"
...
translate russian d2a2_58750dc7:
    ...
    C wink "Ага, разве тебе не НРАВИТСЯ Бог из машины? Мы не можем проиграть!"
...
translate russian d2a2_a1d51192:
    ...
    O blink "Будем надеяться, что тебе не придется использовать это слишком часто."
...
translate russian d2a2_018a03eb:
    ...
    O default "[t_clue]Совместными усилиями[t_cluee] мы справимся, [name_player]."
...
translate russian d2a2_aaab68ed:
    ...
    O sideeye "А теперь. Сесилия. Дверь."

# game/script_day2.rpy:1751
...
translate russian d2a2_1756c4fb:
    ...
    C sobbing "Ах, мои бедные, мокрые волосы..."
...
translate russian d2a2_bdc1d3d4:
    ...
    I "Если преступник в подвале, всё закончится кульминацией."

# game/script_day2.rpy:1757
translate russian d2a2_0514b237:

    # I "And yet... I can't help but wonder about all the [t_clue]remaining mysteries[t_cluee]..."
    I "И всё же... Я не могу не думать о всех [t_clue]оставшихся тайнах[t_cluee]..."
...
translate russian d2a2_basement_8f53e09f:
    ...
    Y "Может, тут есть что-нибудь похожее..."
...
translate russian d2a2_basement_0f6b0d56:
    ...
    O "Подождите... Мои глаза привыкают к темноте... Кажется, на стене есть инструменты."

# game/script_day2.rpy:1834
translate russian d2a2_basement_c6fa2c87:

    # C "Ooh! And where there are tools, there's...what exactly?"
    C "Ооо! А где инструменты, там есть...что именно?"

# game/script_day2.rpy:1835
translate russian d2a2_basement_cf76c77d:
    ...
    O "Если это хоть немного похоже на подвал моего отца, тут должны храниться различные хозяйственные вещи."
...
translate russian d2a2_basement_9ca9a6e7:
    ...
    Y worried "Эргх... В следующий раз предупреждайте..." with hpunch
...
translate russian d2a2_basement_fc372b10:
    ...
    Y afraid "УАААААААААА!!!" with shakelong

# game/script_day2.rpy:1877
translate russian d2a2_basement_3cc1ff3d:

    # Y "Wh-what is..." with shakeonce
    Y "Ч-что это..." with shakeonce
...
translate russian d2a2_basement_2e0a341b:
    ...
    Y shocked "...Ч-что с вами двумя не так?"
...
translate russian d2a2_basement_c0a24eb4:
    ...
    O annoyed "Ничего!" with shakeshort
...
translate russian d2a2_basement_59cc1d91:
    ...
    O leering2 "[name_player]. Я не верю, что это труп преступника."

# game/script_day2.rpy:1892
translate russian d2a2_basement_75b03b02:
    ...
    O irritated "Он точно мёртв и разлагается уже [t_clue]очень долгое время[t_cluee]. Если уж на то пошло, он может быть одной из первых жертв."

# game/script_day2.rpy:1893
translate russian d2a2_basement_bbeb6511:

    # Y sad "Y-yeah... I guess that makes sense..."
    Y sad "А-ага... Думаю, это имеет смысл..."
...
translate russian d2a2_basement_50756dc2:
    ...
    Y leering "Нет, кто-то должен быть здесь. Это единственное объяснение, почему я не смогла найти того, кто убил Рию в гостиной."

# game/script_day2.rpy:1906
translate russian d2a2_basement_5ba04541:

    # C surprised "So you think there's someone hiding somewhere around here?"
    C surprised "Так ты думаешь, что кто-то прячется где-то здесь?"
...
translate russian d2a2_basement_b95ed44c:
    ...
    Y sad "Ага... Давайте будем настороже и внимательно осмотримся..."
...
translate russian d2a2_basement_00075932:
    ...
    O blink "Д-да, согласна. Тут может быть спрятано что-то интересное..."

# game/script_day2.rpy:1912
translate russian d2a2_basement_fd950415:

    # O thinking "We should take some time looking around. But be careful."
    O thinking "Нам стоит потратить немного времени на осмотр. Но будьте осторожны."

# game/script_day2.rpy:1913
...
translate russian d2a2_basement_202bd52e:
    ...
    I "Почему они всё ещё скрывают от меня какие-то секреты после всего, что мы пережили?!" with shakeonce
...
translate russian d2a2_basement_01612a1d:
    ...
    I "Сейчас важно только благополучно сбежать. И для этого нам нужно [t_clue]найти преступника[t_cluee]..."
...
translate russian d2a2_basement_ba4434ad:
    ...
    Y leering "Хорошо, давайте внимательно осмотрим это место."

# game/script_day2.rpy:1932
translate russian d2a2_basement_6971bbb8:

    # I "I should try to get Cece and Ria to talk to me more too..."
    I "Мне стоит попробовать заставить Сеси и Рию поговорить со мной..."
...
translate russian d2a2_basement_end_19bafee3:
    ...
    Y thinking "Думаю, можно с уверенностью сказать, что единственное место, где преступник может прятаться, это комната за той [t_clue]запертой дверью[t_cluee]."

# game/script_day2.rpy:1995
translate russian d2a2_basement_end_6130ea01:

    # C sad "Again with the locked doors..."
    C sad "Снова эти запертые двери..."

# game/script_day2.rpy:1996
translate russian d2a2_basement_end_eb42a7fc:
    ...
    O blink "Мы довольно тщательно осмотрели весь дом, и больше нет никаких таинственных ключей."

# game/script_day2.rpy:1997
translate russian d2a2_basement_end_31579132:
    ...
    Y leering "Это значит, ключ должен быть где-то здесь. Давайте осмотрим пол немного тщательнее."

# game/script_day2.rpy:2003
translate russian d2a2_basement_end_8de564ce:

    # C "Mrghhh... Keys are so easy to miss, though..."
    C "Мргххх... Ключи так легко пропустить..."

# game/script_day2.rpy:2005
translate russian d2a2_basement_end_3c0f7701:
    ...
    C "Тут так темно, что даже если мы будем в упор смотреть на пол, я не думаю, что--{w=1.0}{nw}"

# game/script_day2.rpy:2009
translate russian d2a2_basement_end_c6bfa160:

    # extend " ACK!!" with shakeshort
    extend "АЦК!!" with shakeshort

# game/script_day2.rpy:2014
translate russian d2a2_basement_end_47e1846e:

    # O panicked "Hey!" with hpunch
    O panicked "Эй!" with hpunch

# game/script_day2.rpy:2017
translate russian d2a2_basement_end_ee5201ef:

    # Y panicked "Cece?!" with hpunch
    Y panicked "Сеси?!" with hpunch

# game/script_day2.rpy:2018
...
translate russian d2a2_basement_end_834b0dc9:
    ...
    O shouting "Эй! Придержи себя!" with shakeonce
...
translate russian d2a2_basement_end_e27e6038:
    ...
    O irritated "...Тцк. Она отключилась."
...
translate russian d2a2_basement_end_22a16aab:
    ...
    O thinking "Похоже, она споткнулась и ударилась головой о ножку...чего бы это ни было."

# game/script_day2.rpy:2028
...
translate russian d2a2_basement_end_ef1f712c:
    ...
    O surprised "...Хмм? Здесь что-то есть."

# game/script_day2.rpy:2031
translate russian d2a2_basement_end_6872a323:

    # O "[name_player], take this blue dwarf off my hands."
    O "[name_player], забери этого синего гнома с моих рук."

# game/script_day2.rpy:2032
...
translate russian d2a2_basement_end_96fd682a:
    ...
    O leering2 "[t_clue]Секретный люк[t_cluee]. И если мы заглянем внутрь, увидим, что он ведёт под землю."
...
translate russian d2a2_basement_end_19a79588:
    ...
    O blink "Здесь два возможных варианта, [name_player]."
...
translate russian d2a2_basement_end_581ff976:
    ...
    O "Это может быть секретный [t_clue]альтернативный способ сбежать[t_cluee] из этого дома, или..."
...
translate russian d2a2_basement_end_190eb024:
    ...
    O leering2 "...или это место, где прячется [t_clue]настоящий преступник[t_cluee], готовый напасть на нас, как только мы прыгнем внутрь."
...
translate russian d2a2_basement_end_72418edc:
    ...
    Y thinking "Определённо нет. В любом случае, это какой-то прогресс."
...
translate russian d2a2_basement_end_fcbfb775:
    ...
    Y sad "Однако, похоже, что темнота там, внизу, это ещё более ГЛУБОКАЯ темнота. Я щурюсь изо всех сил, но..."

# game/script_day2.rpy:2065
translate russian d2a2_basement_end_72123755:
    ...
    Y leering "Я вижу тольо то, что дно достаточно близко, и мы можем [t_clue]прыгнуть[t_cluee], но больше ничего."
...
translate russian d2a2_basement_end_77a345b7:
    ...
    O thinking "...Тогда у нас нет выбора. Одна из нас должна будет войти и посмотреть, что произойдет."

# game/script_day2.rpy:2068
...
translate russian d2a2_basement_end_8bede4b9:
    ...
    O default "Так кто же это будет, [name_player]? Я не против прыгнуть."
...
translate russian d2a2_basement_end_c3ff3a15:
    ...
    I "...Снова это [t_clue]неприятное ощущение[t_cluee]. Но почему...? " with shakeonce

# game/script_day2.rpy:2079
translate russian d2a2_basement_end_e43287fc:
    ...
    I "Это просто прыжок в люк. И у меня есть сила путешествовать во времени. Может, не стоит слишком сильно об этом думать?"

# game/script_day2.rpy:2080
...
translate russian d2a2_basement_choice_f2cbd114:
    ...
    O thinking "Д-да, я могу это сделать. Без проблем..." with shakeonce

# game/script_day2.rpy:2107
translate russian d2a2_basement_choice_ca6c7529:

    # I "...She's afraid, isn't she?"
    I "...Она боится, не так ли?"
...
translate russian d2a2_basement_choice_bac023ce:
    ...
    Y sad "Ладно, не важно, ты не должна--" with hpunch
...
translate russian d2a2_basement_choice_4f041cfc:
    ...
    O irritated "Я сказала, что могу это сделать! Просто дай мне минуту, чтобы морально подготовиться..." with shakeonce

# game/script_day2.rpy:2112
translate russian d2a2_basement_choice_7b6af474:

    # I "...I kinda feel bad now..."
    I "...Теперь мне как-то неудобно..."

# game/script_day2.rpy:2119
translate russian d2a2_basement_choice_72516afd:

    # O "*deep inhale*{w=1.0}{nw}" with hpunch
    O "*глубокий вдох*{w=1.0}{nw}" with hpunch

# game/script_day2.rpy:2121
translate russian d2a2_basement_choice_656a5bbf:

    # extend thinking " Wheeeeewww..." with shakeshort
    extend thinking "Уууууххх..." with shakeshort

# game/script_day2.rpy:2122
translate russian d2a2_basement_choice_f302cf7c:

    # Y surprised "....."
    Y surprised "....."

# game/script_day2.rpy:2126
...
translate russian d2a2_basement_choice_70640c17:
    ...
    O hidden "...Да, всё хорошо. Хотя похоже, я наступила на что-то."
...
translate russian d2a2_basement_choice_158fda44:
    ...
    O "...Хм. Судя по ощущениям, я думаю, это [t_clue]ключ[t_cluee]."
...
translate russian d2a2_basement_choice_15618bac:
    ...
    Y panicked "Ключ...? Ох! Это может быть ключ от той запертой двери наверху!" with shakeonce
...
translate russian d2a2_basement_choice_da00e7eb:
    ...
    O "Я тоже так думаю. Подожди, дай мне осмотреть это место ещё немного."
...
translate russian d2a2_basement_choice_3a0cf572:
    ...
    O "{size=-10}...Ргх! Что это... Стена...? Похоже, этот путь всё-таки не ведёт наружу...{/size}" with shakeonce

# game/script_day2.rpy:2151
...
translate russian d2a2_basement_choice_3c1905d3:
    ...
    I "{cps=12}Я... Я чувствую слабость... Это...{/cps}" with shakeonce
...
translate russian d2a2_basement_choice_a7ad2eb9:
    ...
    O hidden "{size=-20}[name_player]! Ответь мне!{/size}" with shakelong
...
translate russian d2a2_basement_choice_25eb2205:
    ...
    I "Меня пырнули...но это не так больно, как я думала..."
...
translate russian d2a2_basement_choice_a8b0a6df:
    ...
    I "Если я умру, то остальные двое смогут сбежать через входную дверь..."

# game/script_day2.rpy:2195
translate russian d2a2_basement_choice_246c1e7e:

    # I "...Yeah, why didn't I consider this as an option before?"
    I "...Ага, почему я не рассматривала такой вариант раньше?"
...
translate russian d2a2_basement_choice_178b06c7:
    ...
    I "Нет, просто оставь всё как есть..." with hpunch
...
translate russian d2a2_basement_choice_52051361:
    ...
    KI "[t_ghost]{size=+10}Я НЕ ХОЧУ УМИРААААААААААААААТЬ!!!!!!!!!{/size}[t_ghoste]" with shakelong

# game/script_day2.rpy:2248
translate russian d2a2_basement_choice_7893784f:

    # Y blink "...Let's have Cece jump in."
    Y blink "...Давай попросим Сеси прыгнуть туда."
...
translate russian d2a2_basement_choice_67941fdf:
    ...
    Y blink "Сеси, наверное, тебе повезёт больше, если туда спустишься ты."

# game/script_day2.rpy:2257
translate russian d2a2_basement_choice_9e28de10:
    ...
    O disappointed "[name_player], ты что, забыла, что она сейчас без сознания?"

# game/script_day2.rpy:2259
...
translate russian d2a2_basement_choice_39ce777f:
    ...
    Y scream "ААААААААААААААААААААААААААААААААААААААААААА\nААААААААГГГГГГГГГГГГГХХХХХХХХХХХ!!!" with shakelong

# game/script_day2.rpy:2301
translate russian d2a2_basement_choice_06474a9b:

    # O injured "NRGGHH!! F... [t_clue]Flames[t_cluee]?! Wh-what just..." with shakeshort
    O injured "НРГГХХ!! Ч... [t_clue]Пламя[t_cluee]?! Ч-что только что..." with shakeshort

# game/script_day2.rpy:2303
translate russian d2a2_basement_choice_3e55ca08:

    # O stabbed "A-ah... [name_player]!" with shakeshort
    O stabbed "А-а... [name_player]!" with shakeshort
...
translate russian d2a2_basement_choice_238e837c:
    ...
    O hidden "{size=-10}...Ты! Что ты...{/size}" with shakeonce
...
translate russian d2a2_basement_choice_940607d4:
    ...
    O "{size=-10}...ты [t_clue]обманула[t_cluee] нас! ..... ...мы... {/size}{size=-20}...[name_player] это...{/size}" with shakeshort

# game/script_day2.rpy:2401
translate russian d2a2_basement_choice_bc4aaa2e:

    # KI "[t_ghost]...can't...[t_ghoste]" with shakeonce
    KI "[t_ghost]...не могу...[t_ghoste]" with shakeonce
...
translate russian d2a2_basement_choice_46359d5b:
    ...
    KI "[t_ghost]...так больно... я не...[t_ghoste]"

# game/script_day2.rpy:2404
translate russian d2a2_basement_choice_95ca7322:

    # I "Who is it?" with shakeonce
    I "Кто это?" with shakeonce

# game/script_day2.rpy:2405
translate russian d2a2_basement_choice_4d03988f:
    ...
    extend "{cps=24} Кто это, кто это, кто это, кто это, кто это, кто это, кто это...{/cps}"
...
translate russian d2a2_basement_choice_85843a74:
    ...
    I "{cps=32}КТОЭТОКТОЭТОКТОЭТОКТОЭТОКТОЭТОКТОЭТОКТОЭТО\nКТОЭТОКТОЭТОКТОЭТОКТОЭТОКТОЭТОКТОЭТО--{/cps}" with shakeshort

# game/script_day2.rpy:2410
translate russian d2a2_basement_choice_673760d7:
    ...
    KI "[t_ghost]{size=+5}Я НЕ ХОЧУ УМИРАААААААААААААТЬ!!!{/size}[t_ghoste]" with shakelong

# game/script_day2.rpy:2431
translate russian truename_entry_f21cfcca:

    # I "My name... My [t_clue]true name[t_cluee]...{nw}"
    I "Мое имя... Мое [t_clue]настоящее имя[t_cluee]...{nw}"
...
translate russian d2a3_99188ee0:
    ...
    Y leering "Неважно, кто из нас прыгнет в люк, всё закончится плохо."

# game/script_day2.rpy:2476
translate russian d2a3_fdbc8d7e:

    # Y thinking "We'd be better off waiting until Cece's awake."
    Y thinking "Нам будет лучше подождать, пока Сеси не проснётся."
...
translate russian d2a3_86045c9e:
    ...
    O irritated "У меня тоже есть [t_clue]неприятное ощущение[t_cluee] по поводу того, чтобы спуститься в этот люк." with shakeonce
...
translate russian d2a3_617deba5:
    ...
    O confused "Я говорила, но в то же время я почувствовала что-то странное... Может быть, если..."

# game/script_day2.rpy:2485
translate russian d2a3_a80f79d9:

    # O leering2 "...[name_player]. May I ask what happens if I jump in?{nw}"
    O leering2 "...[name_player]. Могу я спросить, что будет, если я прыгну в люк?{nw}"
...
translate russian d2a3_453d8c20:
    ...
    O irritated "...Ох. Теперь я понимаю, почему ты хочешь подождать."
...
translate russian d2a3_e86205c9:
    ...
    O confused "...А что будет, если {i}ты{/i} прыгнешь в люк?{nw}"
...
translate russian d2a3_25d2dfb4:
    ...
    O thinking "Как будто этот люк станет [t_clue]последним[t_cluee] что я увижу перед тем, как моя жизнь закончится."

# game/script_day2.rpy:2523
translate russian d2a3_8ceccab2:

    # Y depressed "...W-wait. Does that mean..."
    Y depressed "...П-подожди. Значит ли это..."
...
translate russian d2a3_d60b5920:
    ...
    Y afraid2 "Ты...[t_clue]помнишь[t_cluee], как меня здесь убили?" with shakeonce
...
translate russian d2a3_e7f4b413:
    ...
    O confused "Хм. Это странно. Как только ты это сказала, предчувствие [t_clue]внезапно исчезло[t_cluee]."

# game/script_day2.rpy:2531
translate russian d2a3_b690bc52:

    # Y depressed "...What? How?" with shakeonce
    Y depressed "...Что? Как?" with shakeonce
...
translate russian d2a3_d37894f2:
    ...
    Y shocked "{cps=6}.....{/cps} ...Х-хорошо, тогда..." with hpunch
...
translate russian d2a3_ebb3eb88:
    ...
    I "...Что могут значить слова Рии? В смысле... Я [t_clue]никогда не видела, как она умирает здесь[t_cluee]..."

# game/script_day2.rpy:2538
translate russian d2a3_19b382b4:

    # I "She can't possibly remember that!{w=0.5} Unless...{w=0.5} No..." with shakeonce
    I "Она не может это помнить!{w=0.5} Только если...{w=0.5} Нет..." with shakeonce
...
translate russian d2a3_25e84b20:
    ...
    I "Нет... [t_clue]Я единственный путешественник во времени[t_cluee]...{w=1.0} ...Правда?" with shakeonce

# game/script_day2.rpy:2542
translate russian d2a3_e1d3a06b:

    # C sad "Mrgh..." with hpunch
    C sad "Мргх..." with hpunch

# game/script_day2.rpy:2544
...
translate russian d2a3_ed8ec698:
    ...
    O disappointed "[name_player] думает, что тебе стоит прыгнуть в ту яму."

# game/script_day2.rpy:2568
translate russian d2a3_40e93728:

    # C sobbing "What?! [name_player], how could you...?" with hpunch
    C sobbing "Что?! [name_player], как ты могла...?" with hpunch

# game/script_day2.rpy:2569
translate russian d2a3_72194784:

    # C "I thought what we had was SPECIAL!" with shakeonce
    C "Я думала, что между нами было что-то ОСОБЕННОЕ!" with shakeonce

# game/script_day2.rpy:2570
translate russian d2a3_d6d7b626:

    # Y worried "...Okay, settle down and let me explain from the beginning."
    Y worried "...Хорошо, успокойся, и позволь мне объяснить с самого начала."

# game/script_day2.rpy:2577
translate russian d2a3_0a259b6a:

    # C "I see, and that's why you waited for me to wake up."
    C "Понятно, и поэтому ты ждала, пока я проснусь."

# game/script_day2.rpy:2578
...
translate russian d2a3_eae85560:
    ...
    C determined "И чтобы было ясно, никто не снимал с меня никакую оде--{w=0.5}{nw}"

# game/script_day2.rpy:2584
translate russian d2a3_58a592a6:

    # extend "oOMAN ON WOMAN VIOLENCEE!!" with shakelong
    extend "еЕВУШКА НА ДЕВУШКУ! НАСИЛИЕЕ!!" with shakelong
...
translate russian d2a3_ba5489cf:
    ...
    O annoyed "Хватит этих вымученных приколов, прыгай уже в эту дыру."
...
translate russian d2a3_c287681f:
    ...
    C "Погоди погоди погоди, у меня для вас есть серьёзное предложение!" with shakeonce
...
translate russian d2a3_c7cb8e69:
    ...
    C thinking "Судя по всему, тот, кто НЕ прыгнет в люк, будет кем-то убит, верно?"

# game/script_day2.rpy:2589
translate russian d2a3_60726d37:
    ...
    I "...Меня тоже убьёт, если я прыгну, но...{w=0.5} ...Нет, я скажу им об этом позже." with hpunch
...
translate russian d2a3_d5efb5d5:
    ...
    C default "Тогда нам нужно, чтобы я осталась наверху и [t_clue]стояла на страже[t_cluee], пока одна из вас прыгнет вниз!"
...
translate russian d2a3_83d3c252:
    ...
    C thinking "Я имею в виду, если преступник, спрятавшийся где-то здесь вас поймает, я ваш лучший шанс выжить, правильно?"
...
translate russian d2a3_93b11d08:
    ...
    I "Рия пилит меня злобным взглядом...{w=0.5} Но это лучше, чем снова сгореть заживо..." with hpunch
...
translate russian d2a3_4206a074:
    ...
    Y panicked "П-прости, Рия, я, наверное... Я имею в виду, ты раньше говорила, что ты не против спрыгнуть, верно?" with shakeonce

# game/script_day2.rpy:2608
translate russian d2a3_4a8d3bd4_1:

    # O surprised "...! That's..." with shakeonce
    O surprised "...! Это..." with shakeonce

# game/script_day2.rpy:2609
translate russian d2a3_4f9e8db2:

    # C blush "It's settled, then! Right this way, milady~"
    C blush "Решено! Тогда сюда, миледи~"

# game/script_day2.rpy:2610
translate russian d2a3_283f1bda:

    # C wink "Watch your step...or, y'know, don't. [u_heart]"
    C wink "Смотри под ноги...или, ну знаешь, не смотри. [u_heart]"

# game/script_day2.rpy:2611
translate russian d2a3_4a5b7164:

    # O annoyed "....." with shakeonce
    O annoyed "....." with shakeonce

# game/script_day2.rpy:2612
...
translate russian d2a3_f85ed336:
    ...
    C grin "Давай, хватит тянуть! Спускайся, Рия~" with vpunch

# game/script_day2.rpy:2623
translate russian d2a3_3accdb9b:

    # O annoyed "DON'T push me!" with shakeshort
    O annoyed "НЕ толкай меня!" with shakeshort
...
translate russian d2a3_55501992:
    ...
    I "Да, она всё ещё кидает на меня взгляды..."

# game/script_day2.rpy:2627
translate russian d2a3_364a8400:

    # Y worried "...Uh... Be careful, Ria." with hpunch
    Y worried "...Эм... Будь осторожна, Рия." with hpunch

# game/script_day2.rpy:2629
translate russian d2a3_5c030ebd:

    # O irritated "{cps=6}.......{/cps}{w=0.5} *sigh*{w=1.0}{nw}"
    O irritated "{cps=6}.......{/cps}{w=0.5} *вздох*{w=1.0}{nw}"

# game/script_day2.rpy:2631
...
translate russian d2a3_67dc4925:
    ...
    Y panicked "Аа? Что ты сказа--" with shakeonce

# game/script_day2.rpy:2633
translate russian d2a3_125d184c:

    # O shouting "HERE GOES!" with shakeshort
    O shouting "ВПЕРЁД!" with shakeshort

# game/script_day2.rpy:2637
...
translate russian d2a3_39911581:
    ...
    Y shouting "Рия! Ты в порядке?!" with shakeshort
...
translate russian d2a3_f83e3070:
    ...
    C surprised "...Серьёзно, ты в порядке, [name_player]? Можешь не быть такой настороженной." with hpunch

# game/script_day2.rpy:2674
translate russian d2a3_4502bf6e:

    # C sad "I said I'd protect you, didn't I?"
    C sad "Я же сказала, что буду защищать тебя, не так ли?"
...
translate russian d2a3_ced7fcb7:
    ...
    O "{size=-10}Здесь есть ключ, но я не думаю, что этот проход куда-то ведёт!{/size}"

# game/script_day2.rpy:2683
translate russian d2a3_ec2d0456:

    # Y leering "A-all right, hurry up and come back! I'll give you a hand!"
    Y leering "Л-ладно, поторопись и возвращайся сюда! Я помогу тебе!"

# game/script_day2.rpy:2685
...
translate russian d2a3_2593d251:
    ...
    C surprised "...? Тебе нужно развернуться, если ты хочешь ей помочь, понимаешь."

# game/script_day2.rpy:2687
translate russian d2a3_6184aba8:

    # Y sad "Right, I'll just..." with hpunch
    Y sad "Верно, я просто..." with hpunch

# game/script_day2.rpy:2689
translate russian d2a3_2c311808:
    ...
    Y panicked "П-подожди, Сеси, ты ведь довольно сильная! Почему бы {i}тебе{/i} не помочь ей, а я продолжу быть начеку." with shakeonce

# game/script_day2.rpy:2691
translate russian d2a3_7017c131:

    # C sad "Uh...sure?"
    C sad "Эм...ты уверена?"

# game/script_day2.rpy:2692
...
translate russian d2a3_c760aa64:
    ...
    Y default "Интересно, почему ключ был прямо под люком, а не спрятан дальше в этом проходе."

# game/script_day2.rpy:2710
translate russian d2a3_8a48bf33:

    # O thinking "Perhaps the culprit was in a rush and threw it in before covering up the hatch?"
    O thinking "Может быть, преступник торопился и просто выкинул его перед тем, как закрыть люк?"

# game/script_day2.rpy:2711
translate russian d2a3_acdef023:
    ...
    Y thinking "Но мы всё ещё не нашли преступника. Разве самый безопасный способ спрятать ключ - это не просто носить его с со--"

# game/script_day2.rpy:2719
translate russian d2a3_684a5a21:

    # Y afraid "WHA--{w=1.0}{nw}" with shakeshort
    Y afraid "ЧТО--{w=1.0}{nw}" with shakeshort

# game/script_day2.rpy:2724
translate russian d2a3_d0e1e4aa:

    # O "EEEEEEK!!" with shakelong
    O "ААААААА!!" with shakelong

# game/script_day2.rpy:2733
translate russian d2a3_3b21aa31_1:

    # I "{cps=6}.....{/cps}"
    I "{cps=6}.....{/cps}"

# game/script_day2.rpy:2735
translate russian d2a3_881db791:

    # I "What...just..." with shakeonce
    I "Что...только что..." with shakeonce

# game/script_day2.rpy:2737
translate russian d2a3_b9e3a038:

    # I "...Cece... You..." with shakeonce
    I "...Сеси... Ты..." with shakeonce

# game/script_day2.rpy:2739
translate russian d2a3_48c8393d:

    # C shouting "[name_player]! Snap out of it! OPEN YOUR EYES!!" with shakeshort
    C shouting "[name_player]! Очнись! ОТКРОЙ ГЛАЗА!!" with shakeshort

# game/script_day2.rpy:2741
translate russian d2a3_6132174f:

    # Y wince "Huh...?" with hpunch
    Y wince "Ах?..." with hpunch
...
translate russian d2a3_6db16536:
    ...
    I "Хорошо, Рия опирается на моё плечо. Сеси всё ещё сражается с тем...зомби..." with shakeonce

# game/script_day2.rpy:2871
translate russian d2a3_805698d9:

    # I "I need to find an escape route!{nw}" with shakeonce
    I "Мне нужно найти способ сбежать!{nw}" with shakeonce
...
translate russian d2a3_e7cefd1c:
    ...
    I "Они сражаются слишком близко к лестнице... Похоже, остался только один путь!" with hpunch
...
translate russian d2a3_library_8480c261:
    ...
    C injured "Мргх! Подожди, [name_player]! Подержи эту дверь! Я перетащу тот комод, чтобы полностью заблокировать её!" with shakeshort

# game/script_day2.rpy:2959
translate russian d2a3_library_0df5c9a2:

    # Y shouting "A-all right!" with shakeshort
    Y shouting "Х-Хорошо!" with shakeshort

# game/script_day2.rpy:2967
translate russian d2a3_library_9680c6d6:

    # Y wince "Mrgh...! Grgh..." with shakeshort
    Y wince "Мргх...! Гргх..." with shakeshort

# game/script_day2.rpy:2971
translate russian d2a3_library_42e93511:

    # C pout "HNNNNGGGGHHHHH!!" with shakelong
    C pout "ХННННГГГГХХХХХ!!" with shakelong

# game/script_day2.rpy:2974
translate russian d2a3_library_28560ced:

    # Y panicked "We got it!" with shakeonce
    Y panicked "Мы сделали это!" with shakeonce

# game/script_day2.rpy:2983
translate russian d2a3_library_b350ae46:

    # C "Yeah... He's still pounding away though..." with shakeonce
    C "Ага... Но он всё ещё продолжает ломиться..." with shakeonce

# game/script_day2.rpy:2985
translate russian d2a3_library_2c57b7cc:

    # C "How's Ria doing?" with shakeonce
    C "Как Рия?" with shakeonce

# game/script_day2.rpy:2986
...
translate russian d2a3_library_3cfc37d0:
    ...
    Y afraid "Она совсем побледнела... Нам нужно остановить кровотечение..." with shakeshort
...
translate russian d2a3_library_f763623c:
    ...
    C thinking "Здесь может быть что-то полезное. [name_player], пойдём осмотримся вокруг!"

# game/script_day2.rpy:2997
translate russian d2a3_library_a0f3ce82:

    # Y panicked "Right! Okay, um..." with shakeonce
    Y panicked "Точно! Да, эм..." with shakeonce

# game/script_day2.rpy:2998
translate russian d2a3_library_7b752f8a:

    # I "This is... I think it's a [t_clue]library[t_cluee]...?"
    I "Это... Я думаю, это [t_clue]библиотека[t_cluee]...?"

# game/script_day2.rpy:2999
translate russian d2a3_library_4601ad82:

    # I "...Wait. What's...that..."
    I "...Подождите. Что...это..."

# game/script_day2.rpy:3018
translate russian d2a3_library_d262b9ad:

    # I "That's..."
    I "Это..."

# game/script_day2.rpy:3099
translate russian d2a3_library_end_3baf1630:

    # Y pained "Agh... He's still pounding away, Ria's still bleeding..." with shakeshort
    Y pained "Агх... Он всё ещё стучит, Рия всё ещё истекает кровью..." with shakeshort

# game/script_day2.rpy:3102
translate russian d2a3_library_end_c774d77f:
    ...
    Y pained2 "После всего этого поиска я не смогла найти ничего, чем мы бы могли перемотать рану..." with shakeshort

# game/script_day2.rpy:3105
translate russian d2a3_library_end_5dc0715b:

    # C happy "Hey, [name_player]! Don't worry, I got it covered!" with vpunch
    C happy "Эй, [name_player]! Не переживай, я всё уладила!" with vpunch

# game/script_day2.rpy:3116
...
translate russian d2a3_library_end_430ee93a:
    ...
    Y panicked "А? ...Ах! Да, ты перемотала её рану этим куском ткани..."

# game/script_day2.rpy:3119
translate russian d2a3_library_end_c3171d2f:

    # Y annoyed "...Wait, where did you get that?"
    Y annoyed "...Подожди, где ты его взяла?"

# game/script_day2.rpy:3122
translate russian d2a3_library_end_a6639784:
    ...
    C default "Там, в том углу. Ну знаешь, где лежит та мёртвая девочка? Я просто отрезала немного от уголка простыни." with shakeshort
...
translate russian d2a3_library_end_293cb237:
    ...
    Y afraid2 "ЭТА ПРОСТЫНЯ ОЧЕВИДНО БЫЛА ДЛЯ ПОГРЕБЕНИЯ!!" with shakeshort
...
translate russian d2a3_library_end_264d52df:
    ...
    C smug "Ой, пф, что эта мёртвая девочка сделает, встанет из мёртвых и попробует нас убить?"
...
translate russian d2a3_library_end_9344c742:
    ...
    Y scream "ПОЧЕМУ, ТЫ ДУМАЕШЬ, МЫ ВООБЩЕ ОКАЗАЛИСЬ ЗДЕСЬ В ЛОВУШКЕ?!" with shakeshort

# game/script_day2.rpy:3131
translate russian d2a3_library_end_f6aa99ba:

    # C shouting "STOP YELLING! Ria's finally starting to settle down!" with shakeshort
    C shouting "ПРЕКРАТИ ОРАТЬ! Рия наконец-то начинает приходить в себя!" with shakeshort
...
translate russian d2a3_library_end_fdef190a:
    ...
    I "Она права. Думаю, она сейчас просто спит..."
...
translate russian d2a3_library_end_a5f1b8ae:
    ...
    Y sad "А-ага... Не похоже, что из этой комнаты есть другой выход..."
...
translate russian d2a3_library_end_0d7b7a8c:
    ...
    C blink "Эта штука - определённо бездумный зомби. Не думаю, что он способен на такие сложные планы как этот."
...
translate russian d2a3_library_end_b803de5c:
    ...
    Y wince "Но он использовал нож... Мог ли бездумный зомби действительно так сделать?" with shakeonce
...
translate russian d2a3_library_end_f0f5d48f:
    ...
    C "Произошло много всякого, так что я не могу винить тебя за то, что ты это упустила, но..."

# game/script_day2.rpy:3153
translate russian d2a3_library_end_832fc697:
    ...
    C determined "Пока мы с ним сражались, я несколько раз порезала его ножом. И сделала несколько ударов.{w=1.0} Но он [t_clue]даже не дёрнулся[t_cluee]."

# game/script_day2.rpy:3155
translate russian d2a3_library_end_0953480f:

    # Y depressed "That's...impossible..." with shakeonce
    Y depressed "Это...невозможно..." with shakeonce

# game/script_day2.rpy:3156
translate russian d2a3_library_end_7e31c108:

    # C "Exactly. That {i}thing{/i} isn't human."
    C "Именно. Это {i}нечто{/i} не человек."
...
translate russian d2a3_library_end_772135aa:
    ...
    C thinking "Это может быть что-то вроде научного эксперимента, который пошёл не по плану. Или андроид, предназначенный для сражений или охраны."
...
translate russian d2a3_library_end_14349547:
    ...
    C blink "Или может быть...это какой-то [t_clue]демон, вызванный из ада[t_cluee]..."

# game/script_day2.rpy:3160
translate russian d2a3_library_end_a2165004:

    # Y shadow "....."
    Y shadow "....."

# game/script_day2.rpy:3162
translate russian d2a3_library_end_8ac1707e:

    # Y "...Aren't you going to gush about it, then? It's the occult...but for real..."
    Y "...Ты же не собираешься восхищаться этим? Это оккультизм...но по-настоящему..."

# game/script_day2.rpy:3164
translate russian d2a3_library_end_5b31a5b4:
    ...
    C sad "Обычно я бы возразила, но не думаю, что у тебя сейчас есть силы спорить."
...
translate russian d2a3_library_end_9f69deb1:
    ...
    C "Давай, садись рядом со мной, [name_player]! Сделаем передышку!"
...
translate russian d2a3_library_end_67beeac6:
    ...
    Y shadow "{cps=12}...Я посижу, но не знаю, сколько...я смогу...{/cps}"

# game/script_day2.rpy:3181
translate russian d2a3_library_end_1a482f07:

    # I "....." with shakeshort
    I "....." with shakeshort

# game/script_day2.rpy:3183
translate russian d2a3_library_end_450c033d:

    # I "...Crap... I'm so sleepy..." with hpunch
    I "...Чёрт... Мне так хочется спать..." with hpunch

# game/script_day2.rpy:3185
...
translate russian d2a3_library_end_d843dd92:
    ...
    C blink "Зомби нигде не видно, но, может, нам стоит подождать, пока ты отдохнёшь, прежде чем двигаться дальше."
...
translate russian d2a3_library_end_e9b9d2f6:
    ...
    C "Догадываюсь, ты тоже устала от этих путешествий во времени?"
...
translate russian d2a3_library_end_4278f738:
    ...
    C default "Помнишь? Ты была без сознания сразу после того, как всё это началось."

# game/script_day2.rpy:3237
translate russian d2a3_library_end_74cbd915:
    ...
    C blink "Начинается убийственная игра, вдруг ты говоришь, что путешествуешь во времени, задаешь кучу вопросов, а потом баю-бай!"
...
translate russian d2a3_library_end_9d96b4aa:
    ...
    C sweatdrop "Ооох, ты говоришь о том, что было {i}до{/i} твоего путешествия во времени? Эмм... Я не до конца понимаю, о чём ты." with hpunch

# game/script_day2.rpy:3262
translate russian d2a3_library_end_fbe1c3a3:
    ...
    C thinking "Я имею в виду, было много, МНОГО раз, когда я пытался убить тебя и Рию, не так ли?"
...
translate russian d2a3_library_end_ce4dbd11:
    ...
    Y wince "Нет-- Да, в смысле...{cps=1} {/cps}Я говорю про то, что было здесь, в подвале." with hpunch

# game/script_day2.rpy:3268
translate russian d2a3_library_end_8f20d6ad:
    ...
    Y sad "Каждый раз мы спускались сюда втроём. Каждый раз мы обещали друг другу, что сбежим отсюда вместе."
...
translate russian d2a3_library_end_d582eb45:
    ...
    Y wince "Но как только я увидела тот люк, я..." with shakeonce

# game/script_day2.rpy:3275
translate russian d2a3_library_end_d8fe2432:
    ...
    Y troubled "Я вдруг всё вспомнила. Каждый раз возле того люка происходило что-то ужасное." with shakeonce

# game/script_day2.rpy:3276
translate russian d2a3_library_end_4214be7d:
    ...
    Y shocked "Например, когда прыгнула я, меня...меня поглотил огонь.{cps=1} {/cps}А Рия бы...противостояла кому-то, кто нас обманул..."

# game/script_day2.rpy:3278
translate russian d2a3_library_end_47ed4469:

    # C surprised "Huh? [t_clue]Flames[t_cluee]?"
    C surprised "А? [t_clue]Огонь[t_cluee]?"

# game/script_day2.rpy:3279
translate russian d2a3_library_end_df4b5c88:

    # Y pained2 "But if Ria jumped in, I would get stabbed in the back..." with shakeonce
    Y pained2 "Но если бы Рия прыгнула, меня бы ударили ножом в спину..." with shakeonce

# game/script_day2.rpy:3285
...
translate russian d2a3_library_end_b558e464:
    ...
    Y wince "Я не знала, что этот труп может ещё двигаться, так что..."

# game/script_day2.rpy:3288
translate russian d2a3_library_end_5b1a50fc:

    # Y "So I thought... Maybe..." with shakeonce
    Y "Так что я подумала... Возможно..." with shakeonce
...
translate russian d2a3_library_end_a6841155:
    ...
    C blink "...Что я [t_clue]предала[t_cluee] тебя и Рию, верно?"

# game/script_day2.rpy:3292
...
translate russian d2a3_library_end_1b88a869:
    ...
    C "Как бы то ни было, я не думаю, что ты ошибалась, подозревая меня."
...
translate russian d2a3_library_end_551eeeda:
    ...
    C thinking "Ты знаешь, какая я, а также что я сделала в альтернативных будущих."

# game/script_day2.rpy:3295
translate russian d2a3_library_end_cbb64e5f:
    ...
    C sweatdrop "И к тому же, никто не мог бы ожидать, что труп встанет и попытается нас убить."

# game/script_day2.rpy:3296
translate russian d2a3_library_end_b0ff9ea3:

    # Y sad "Even so, I... I should've trusted you..." with shakeonce
    Y sad "Тем не менее, я... Я должна была довериться тебе..." with shakeonce
...
translate russian d2a3_library_end_c5dedaf9:
    ...
    Y default "Ты рисковала своей жизнью, чтобы спасти нас от той...штуки. Так что...спасибо."

# game/script_day2.rpy:3299
translate russian d2a3_library_end_9a16cc5b:

    # Y happy "Thank you so much."
    Y happy "Огромное спасибо."
...
translate russian d2a3_library_end_493e335e:
    ...
    Y relaxed "Все в порядке. Я просто хотела это сказать."

# game/script_day2.rpy:3309
translate russian d2a3_library_end_5530e299:

    # C blush "O-okay, good! I heard you loud and clear! Ahaha..." with shakeonce
    C blush "О-окей, хорошо! Я тебя поняла! Ахаха..." with shakeonce
...
translate russian d2a3_library_end_88f46895:
    ...
    I "...или произойдет что-то ещё, связанное с оккультизмом, и нас всех сотрёт..."

# game/script_day2.rpy:3331
translate russian d2a3_library_end_01bec81b:
    ...
    I "Теперь возможно всё. Я имею в виду, [t_clue]я мертва[t_cluee]. Я вообще не должна быть, но вот я здесь."
...
translate russian d2a3_library_end_7d87a441:
    ...
    I "...Какова цель этой убийственной игры? Почему мы здесь?"

# game/script_day2.rpy:3333
...
translate russian d2a3_library_end_2bb527de:
    ...
    I "{cps=12}Ответы...{/cps}{w=0.5} [t_clue]Я найду их все[t_cluee]...{w=0.5} Когда я... прос...{size=-10}нусь...{/size}"

# game/script_day2.rpy:3340
...
translate russian d2a3_library_cece_hearttoheart_33b653e9:
    ...
    Y blink "...На самом деле, Сеси, я хотела кое-что у тебя спросить."

# game/script_day2.rpy:3347
translate russian d2a3_library_cece_hearttoheart_3f6ad74d:

    # C default "Hmm? What is it?"
    C default "Хмм? Что такое?"
...
translate russian d2a3_library_cece_hearttoheart_fd9d1edb:
    ...
    Y thinking "Да, это предложение было... Эм... Как же оно...?{nw}"
...
translate russian d2a3_library_cece_hearttoheart_49947541:
    ...
    Y surprised "Как и обещала, я запомнила это, но не уверена, что это значит..."

# game/script_day2.rpy:3400
translate russian d2a3_library_cece_hearttoheart_3bdab9e7:

    # C sad "Hmm...? That sounds kinda familiar..."
    C sad "Хмм...? Это что-то знакомое..."
...
translate russian d2a3_library_cece_hearttoheart_d6a9be37:
    ...
    Y worried2 "Ага, возможно, я что-то не так поняла. Или, может быть, всё не так поняла."
...
translate russian d2a3_library_cece_hearttoheart_ae10d72e:
    ...
    C "[t_clue]\"Серена убила рыбу-клоуна.\"[t_cluee] Это было такое предложение?"

# game/script_day2.rpy:3405
translate russian d2a3_library_cece_hearttoheart_5ac84888:

    # Y panicked "Y-yeah, that was it!" with shakeonce
    Y panicked "А-ага, это было оно!" with shakeonce

# game/script_day2.rpy:3407
...
translate russian d2a3_library_cece_hearttoheart_85e99844:
    ...
    Y thinking "Наверное, это было что-то, что Сеси из другой временной линии просто случайно придумала, а?"
...
translate russian d2a3_library_cece_hearttoheart_37ebe4ea:
    ...
    C thinking "Нет. Я знаю, почему та Сеси сказала тебе это."
...
translate russian d2a3_library_cece_hearttoheart_db9c2dd1:
    ...
    C default "[name_player]. Ты только что собиралась вернуться в прошлое, верно?"
...
translate russian d2a3_library_cece_hearttoheart_6dc9f871:
    ...
    C blink "\"Серена убила рыбу-клоуна.\"{w=1.0} Это [t_clue]секрет, который я никому не говорила[t_cluee], даже семье."

# game/script_day2.rpy:3417
translate russian d2a3_library_cece_hearttoheart_3aed9c65:

    # Y panicked "What?! Then..." with shakeonce
    Y panicked "Что?! Тогда..." with shakeonce
...
translate russian d2a3_library_cece_hearttoheart_f174f0cd:
    ...
    C default "Ага. Та Сеси пыталась [t_clue]что-то проверить[t_cluee]. И думаю, я знаю что."

# game/script_day2.rpy:3419
translate russian d2a3_library_cece_hearttoheart_74158214:

    # Y leering "Wh-what is it?" with shakeonce
    Y leering "Ч-что же?" with shakeonce
...
translate russian d2a3_library_cece_hearttoheart_0b1c88b6:
    ...
    C sweatdrop "...Ты уверена, что хочешь узнать? Это может сделать всё...сложнее.{nw}"
...
translate russian d2a3_library_cece_hearttoheart_c52ee338:
    ...
    Y leering "Сеси, пожалуйста, скажи мне. Что ты пыталась проверить, сказав мне этот секрет?"
...
translate russian d2a3_library_cece_hearttoheart_df4445c4:
    ...
    C blink "Теперь, конечно, я не могу быть на 100%% уверена, но думаю, та Сеси пыталась проверить две вещи."
...
translate russian d2a3_library_cece_hearttoheart_0cbd1242:
    ...
    C default "Во-первых, она проверяла [t_clue]меня[t_cluee]. Теперяшнюю Сеси."
...
translate russian d2a3_library_cece_hearttoheart_092697ab:
    ...
    C thinking "Заставив тебя рассказать мне секрет, о котором никто не мог знать, она проверяет, [t_clue]помню[t_cluee] ли я, как рассказала тебе этот секрет."
...
translate russian d2a3_library_cece_hearttoheart_e82f7923:
    ...
    Y panicked "...Подожди, что? Разве вы не две разные Сеси?" with shakeonce
...
translate russian d2a3_library_cece_hearttoheart_454c02af:
    ...
    C "...Нет. Оказалось, что её теория была правильной."
...
translate russian d2a3_library_cece_hearttoheart_dad82948:
    ...
    C default "Это очень слабое воспоминание, но я смутно [t_clue]помню, что кому-то рассказывал этот секрет[t_cluee]."
...
translate russian d2a3_library_cece_hearttoheart_d3be91f2:
    ...
    C blink "А это проверило и подтвердило вторую вещь."
...
translate russian d2a3_library_cece_hearttoheart_cbea1ce9:
    ...
    C smug "Она проверяла [t_clue]природу[t_cluee] твоей способности путешествовать во времени."
...
translate russian d2a3_library_cece_hearttoheart_bb6fd41c:
    ...
    Y worried "\"Природу\" моих путешествий во времени?"
...
translate russian d2a3_library_cece_hearttoheart_7f4562ce:
    ...
    C sweatdrop "Хмм... Твой недоумевающий взгляд говорит мне, что ты не знакома с типичными сюжетами путешествий во времени, которые часто встречаются в научно-фантастических историях."
...
translate russian d2a3_library_cece_hearttoheart_1c5ff56d:
    ...
    Y sad "...Разве ты не продолжишь жить? А Рия всё равно будет мертва..."
...
translate russian d2a3_library_cece_hearttoheart_993c694c:
    ...
    C blink "То есть я сбегу через входную дверь, верно?"
...
translate russian d2a3_library_cece_hearttoheart_d2ba7795:
    ...
    C smile "Да, \"ты\" вернулась в прошлое. А что насчет твоего тела?"
...
translate russian d2a3_library_cece_hearttoheart_003ecd5b:
    ...
    extend panicked "О! Подожди, нет, наверное, возвращается назад только моё [t_clue]сознание[t_cluee], так как я всегда прихожу в себя в спящем теле." with hpunch
...
translate russian d2a3_library_cece_hearttoheart_fd742ac7:
    ...
    C happy "Именно! Так что ты думаешь происходит с твоим старым телом, всё ещё застрявшим в будущем?"
...
translate russian d2a3_library_cece_hearttoheart_537e7e64:
    ...
    Y thinking "Эм... Оно либо продолжает жить без разума, либо..."
...
translate russian d2a3_library_cece_hearttoheart_25ec23f8:
    ...
    Y surprised "Подожди, разве оно не становится другой \"мною\"?"
...
translate russian d2a3_library_cece_hearttoheart_56671874:
    ...
    C smile "Это была бы [t_clue]теория множественных временных линий[t_cluee], да."
...
translate russian d2a3_library_cece_hearttoheart_4681aa4b:
    ...
    C blink "Если бы твои путешествия во времени были такого типа, это означало бы, что каждый раз, когда кто-то из нас умирал..."
...
translate russian d2a3_library_cece_hearttoheart_a0f80a2d:
    ...
    C "...этот человек [t_clue]оставался мёртвым[t_cluee] в этой временной линии, а ты просто прыгаешь из одной линии в другую, пока не найдешь оптимальный исход."
...
translate russian d2a3_library_cece_hearttoheart_3fe525b6:
    ...
    Y thinking "...\"Если\"? То есть... То, что происходит, это НЕ такое?"
...
translate russian d2a3_library_cece_hearttoheart_a8d83e74:
    ...
    Y thinking "Разве ты...эм...не перематываешь время? Типа, твои тела и сознания возвращаются в исходное состояние?"

# game/script_day2.rpy:3465
translate russian d2a3_library_cece_hearttoheart_20091ffc:
    ...
    C surprised "Интересно... То есть это будет похоже на то, как каждая миллисекунда, наши текущие состояния сохраняются во вселенной?"
...
translate russian d2a3_library_cece_hearttoheart_13025e8c:
    ...
    C "Это было бы похоже на то, что мы живём в [t_clue]видеоигре[t_cluee] или что-то в этом роде!"

# game/script_day2.rpy:3469
translate russian d2a3_library_cece_hearttoheart_341e308e:

    # Y worried "Uh... I think you lost me..."
    Y worried "Эм... Думаю, ты меня запутала..."
...
translate russian d2a3_library_cece_hearttoheart_c067e3c0:
    ...
    C blink "На самом деле, это не так уж далеко от истины. Главное отличие в том, что наши сознания, похоже, сохраняют часть информации."
...
translate russian d2a3_library_cece_hearttoheart_cbc97def:
    ...
    Y thinking "...Я имею в виду, если это будущее не произошло, то вы двое в тот момент исчезли бы, верно?"

# game/script_day2.rpy:3474
translate russian d2a3_library_cece_hearttoheart_68d02805:
    ...
    C sweatdrop "Это пугающая мысль... Похоже, пока хотя бы одна наша версия существует, а...?"

# game/script_day2.rpy:3475
translate russian d2a3_library_cece_hearttoheart_cee4ae59:
    ...
    C blink "Но нет, этого не может быть так, потому что я помню, как другая я я рассказывала тебе этот секрет."
...
translate russian d2a3_library_cece_hearttoheart_e2854dc5:
    ...
    Y surprised "Верно... Так что это значит?"
...
translate russian d2a3_library_cece_hearttoheart_f3d0ce61:
    ...
    C default "Проще говоря, не совсем правильно называть себя \"путешественником\" во времени."
...
translate russian d2a3_library_cece_hearttoheart_d5966710:
    ...
    C blink "На самом деле ты делаешь...{w=1.0}{nw}"
...
translate russian d2a3_library_cece_hearttoheart_5d80432e:
    ...
    extend smile "[t_clue]принудительное откатывание мира назад во времени[t_cluee]." with shakeonce
...
translate russian d2a3_library_cece_hearttoheart_efeac172:
    ...
    C blink "И это несовершенная сила, потому что информация из перемотанного будущего [t_clue]просачивается в прошлое[t_cluee]."
...
translate russian d2a3_library_cece_hearttoheart_fe3be31f:
    ...
    Y shocked "Откатываю...мир? То есть, мир прямо \"мир\"? Включая всё за пределами этого дома?" with shakeonce
...
translate russian d2a3_library_cece_hearttoheart_ee344b43:
    ...
    C thinking "Это возможно. У нас нет способов связаться с внешним миром."
...
translate russian d2a3_library_cece_hearttoheart_adc674f6:
    ...
    C smug "Насколько нам известно, там хаос и паника, потому что люди внезапно могут предсказывать будущее."
...
translate russian d2a3_library_cece_hearttoheart_1f6e16e8:
    ...
    C "Обманывать в лотерее, совершать идеальные убийства, возможно, даже получать видения апокалипсиса..."
...
translate russian d2a3_library_cece_hearttoheart_8bcc72f8:
    ...
    Y afraid "Значит... Каждый раз, когда я \"возвращалась в прошлое\"... Я..." with hpunch

# game/script_day2.rpy:3491
translate russian d2a3_library_cece_hearttoheart_8cea0c4f:
    ...
    C sweatdrop "Ага... Видишь, вот почему я не была уверена, что тебе это нужно рассказывать."

# game/script_day2.rpy:3492
translate russian d2a3_library_cece_hearttoheart_5866adab:
    ...
    C thinking "Но помни, что ничего не доказано. По крайней мере, пока мы не выйдем наружу и не увидим всё собственными глазами."
...
translate russian d2a3_library_cece_hearttoheart_1e4ec659:
    ...
    Y sad "То, как ты это описываешь, не похоже, что это будет очень полезной информацией, да?"
...
translate russian d2a3_library_cece_hearttoheart_ff39497d:
    ...
    C blink "Совсем нет. Но... Я чувствую, ты всё равно об этом узнаешь, не смотря ни на что..."
...
translate russian d2a3_library_cece_hearttoheart_7148171b:
    ...
    C happy "В любом случае, вау, какая же ты болтунья, вот так вываливать женские секретики!"
...
translate russian d2a3_library_cece_hearttoheart_db541b74:
    ...
    Y default "Но что это значит? Кто такая Серена? И что за рыба-клоун?"

# game/script_day2.rpy:3511
translate russian d2a3_library_cece_hearttoheart_1566699e:
    ...
    C sweatdrop "С-серьёзно? Ты действительно хочешь ещё больше вторгаться в мою личную жизнь?"
...
translate russian d2a3_library_cece_hearttoheart_f5f77883:
    ...
    Y thinking "Ну, если ты действительно не хочешь об этом говорить..."
...
translate russian d2a3_library_cece_hearttoheart_329755e1:
    ...
    C blink "Эх. Всё в порядке. Этой истории всй равно уже больше десяти лет."

# game/script_day2.rpy:3518
translate russian d2a3_library_cece_hearttoheart_52a6f789:
    ...
    C "Когда я была в третьем классе, у нас были несколько рыбок. Одна рыба-клоун, три золотые рыбки и...гуппи. Если я правильно помню."
...
translate russian d2a3_library_cece_hearttoheart_124e8af9:
    ...
    C "Это был способ научить нас, детей, заботиться о живых существах. Знаешь, всякие такие полезные штуки."
...
translate russian d2a3_library_cece_hearttoheart_caa8f475:
    ...
    C "Учитель велел нам заботиться о каждой рыбке по парам. И мы меняли пары каждую неделю."

# game/script_day2.rpy:3525
translate russian d2a3_library_cece_hearttoheart_cb5f28e7:
    ...
    C "Однажды настала моя очередь ухаживать за рыбой-клоуном вместе с этой девочкой по имени [t_clue]Серена[t_cluee]."

# game/script_day2.rpy:3526
translate russian d2a3_library_cece_hearttoheart_bba8486a:
    ...
    C "Серена была популярной. Она всегда была окружена как мальчиками, так и девочками. И она прекрасно ладила с ними всеми."

# game/script_day2.rpy:3527
translate russian d2a3_library_cece_hearttoheart_2800c557:
    ...
    C "Я тоже не презирала её. Она не позволяла своей популярности раздувать её эго или что-то в этом роде."

# game/script_day2.rpy:3545
translate russian d2a3_library_cece_hearttoheart_b9fa45e7:
    ...
    C "Короче, да, на той неделе [t_clue]Серена убила рыбу-клоуна[t_cluee]."
...
translate russian d2a3_library_cece_hearttoheart_fb536991:
    ...
    C "Она дала ей неправильную еду. Та не смогла её переварить. И наутро всплыла кверху брюхом."

# game/script_day2.rpy:3547
translate russian d2a3_library_cece_hearttoheart_ce039b90:

    # C "Of course, it was an accident, but..."
    C "Конечно, это был несчастный случай, но..."

# game/script_day2.rpy:3552
translate russian d2a3_library_cece_hearttoheart_802ceecb:
    ...
    C "На следующий день в классе начался переполох. Множество глаз уставились на Серену, которая накануне кормила рыбу."

# game/script_day2.rpy:3553
translate russian d2a3_library_cece_hearttoheart_dac28fcf:
    ...
    C "О, мне стоит объяснить, что я не была самой заметной девочкой. Мои волосы были намного короче. И не покрашены. Но они всё равно были пушистые!"

# game/script_day2.rpy:3554
translate russian d2a3_library_cece_hearttoheart_de0aad6d:
    ...
    C "Короче, Серена оказалась в затруднительном положении из-за того, что случилось накануне."

# game/script_day2.rpy:3555
...
translate russian d2a3_library_cece_hearttoheart_25a27c30:
    ...
    C "Она молчала, пока учитель продолжал спрашивать, что случилось."

# game/script_day2.rpy:3563
translate russian d2a3_library_cece_hearttoheart_738afc99:
    ...
    C "...А потом, будучи бестолковым ребёнком, я подошла к аквариуму с рыбой-клоуном и сказала следующее:"

# game/script_day2.rpy:3567
translate russian d2a3_library_cece_hearttoheart_f45d1a55:
    ...
    C "{cps=15}\"Вау... Её глаза все серые и пятнистые! Мёртвые вещи такие красивые...\"{/cps}"
...
translate russian d2a3_library_cece_hearttoheart_29818c2d:
    ...
    C blink "...Это был мой первый раз, когда я увидела мёртвое существо. Моё первое столкновение со смертью, и я была очарована."
...
translate russian d2a3_library_cece_hearttoheart_45b0034c:
    ...
    C default "Как ты можешь догадаться, все были в шоке, включая учителя."

# game/script_day2.rpy:3580
translate russian d2a3_library_cece_hearttoheart_f318a946:
    ...
    C blink "Какой-то мальчик крикнул, что это я, наверное, убила рыбу-клоуна, и...правда стала такой."
...
translate russian d2a3_library_cece_hearttoheart_fc1707fa:
    ...
    Y shouting "Что... Но ты была невиновна!" with shakeonce
...
translate russian d2a3_library_cece_hearttoheart_2b7701e4:
    ...
    C thinking "{i}Была{/i}? В смысле, для восьмилетней девочки, это было странно такое сказать."
...
translate russian d2a3_library_cece_hearttoheart_bc31b3d7:
    ...
    Y angry "Нет, я имею в виду, это же ты не убила рыбу-клоуна! Ты же защищала себя?!" with shakeonce
...
translate russian d2a3_library_cece_hearttoheart_8b9093c2:
    ...
    Y blink "...Ты сделала это, чтобы защитить Серену, не так ли? Поэтому ты никому это не рассказывала до сегодняшнего дня."
...
translate russian d2a3_library_cece_hearttoheart_23f9378e:
    ...
    C thinking "Хмм... Извини, но это не совсем верно. Мне нравилась Серена, но не настолько, чтобы защищать её. Мы не были настоящими друзьями."
...
translate russian d2a3_library_cece_hearttoheart_da67aa1a:
    ...
    Y sad "Так почему ты ничего не сказала? Разве остальные дети не ненавидели тебя до конца года?"
...
translate russian d2a3_library_cece_hearttoheart_d786cca7:
    ...
    C happy "До конца начальной школы, ага!" with vpunch

# game/script_day2.rpy:3591
translate russian d2a3_library_cece_hearttoheart_02f1bb5f:
    ...
    Y panicked "Как ты можешь говорить об этом так радостно? Это ведь было сложно для тебя?"
...
translate russian d2a3_library_cece_hearttoheart_d5f1e6e5:
    ...
    C sweatdrop "Сложно... Мргх... Я не знаю, [name_player], начальная школа была тем временем, когда я впервые увлеклась оккультизмом."
...
translate russian d2a3_library_cece_hearttoheart_f37d5ce0:
    ...
    C happy "Могу с уверенностью сказать, что у меня остались только [t_clue]счастливые воспоминания[t_cluee] о том времени."

# game/script_day2.rpy:3594
translate russian d2a3_library_cece_hearttoheart_3d6bd2ec:

    # Y sad "...Did you...not make any friends...?"
    Y sad "...Ты...не завела друзей...?"
...
translate russian d2a3_library_cece_hearttoheart_66e998a0:
    ...
    C thinking "...Хмм?{w=1.0}{nw}"

# game/script_day2.rpy:3598
...
translate russian d2a3_library_cece_hearttoheart_2c4e95e3:
    ...
    C default "Когда её почти заставили предать своих друзей, она была в глубоком отчаянии."
...
translate russian d2a3_library_cece_hearttoheart_2956f77f:
    ...
    C "Даже такой человек как я смог понять, что мнения других людей значили для неё всё."

# game/script_day2.rpy:3601
translate russian d2a3_library_cece_hearttoheart_091bcf41:
    ...
    C sad "И как-то... Мне казалось, что будет жалко видеть, как всё, что она построила, разрушится вот так просто. Я...не хотела этого видеть."
...
translate russian d2a3_library_cece_hearttoheart_82171cab:
    ...
    C smile "Люди должны иметь возможность удерживать то, что для них важнее всего, понимаешь?"
...
translate russian d2a3_library_cece_hearttoheart_89d0e657:
    ...
    C sweatdrop "Боже, я никогда до этого не говорила о себе так много ... [name_player], ты всегда добиваешься своего, а?" with hpunch

# game/script_day2.rpy:3606
translate russian d2a3_library_cece_hearttoheart_ff0c7aba:

    # Y default "{cps=6}.....{/cps} Cece...{w=0.5}{nw}"
    Y default "{cps=6}.....{/cps} Сеси...{w=0.5}{nw}"
...
translate russian d2a3_library_cece_hearttoheart_d0fcf641:
    ...
    Y relaxed "Ты всё-таки хороший человек."
...
translate russian d2a3_library_cece_hearttoheart_f95f51fd:
    ...
    C surprised "Хм? Откуда это в тебе?"
...
translate russian d2a3_library_cece_hearttoheart_c514ec4b:
    ...
    Y blink "То, как ты говоришь о себе...и о своём прошлом..."
...
translate russian d2a3_library_cece_hearttoheart_a0def964:
    ...
    Y default "У меня ощущение, что ты не можешь сказать ничего хорошего ни о том, ни о другом."
...
translate russian d2a3_library_cece_hearttoheart_6d7b3a8e:
    ...
    C sweatdrop "Ахаха... Я понимаю, что ты имеешь в виду, но это не значит, что у меня низкая самооценка или что-то в этом роде." with hpunch
...
translate russian d2a3_library_cece_hearttoheart_f68daeb8:
    ...
    C thinking "Может быть, но это не было из-за героизма или дружбы, или какого-то гражданского долга..."
...
translate russian d2a3_library_cece_hearttoheart_232b7edd:
    ...
    C sweatdrop "Честно, я так поступила потому, что это был самый простой выбор. Представь, как ты убеждаешь целый класс детей, что--"
...
translate russian d2a3_library_cece_hearttoheart_f1fb5a0c:
    ...
    Y blink "Ты сказала, что понимала, что друзья Серены были для неё важны."
...
translate russian d2a3_library_cece_hearttoheart_5c77e2e1:
    ...
    Y "Ты хранила этот секрет так долго, потому что хотела защитить то, что было важно для какого-то ребёнка."
...
translate russian d2a3_library_cece_hearttoheart_d3052337:
    ...
    Y relaxed "Какого-то ребёнка, который даже не был твоим другом."
...
translate russian d2a3_library_cece_hearttoheart_64f5974a:
    ...
    Y happy "Я думаю, что даже способность понимать, что важно для других людей, доказывает твою человечность."
...
translate russian d2a3_library_cece_hearttoheart_e925652d:
    ...
    Y confused "Ты реально странная." with hpunch
...
translate russian d2a3_library_cece_hearttoheart_c4a910fa:
    ...
    C happy "Ахаха! Виновна по всем статьям!" with vpunch
...
translate russian d2a3_library_cece_hearttoheart_e5b96a49:
    ...
    Y relaxed "Ты всё ещё не понимаешь этого, да?"
...
translate russian d2a3_library_cece_hearttoheart_b0ecd57e:
    ...
    Y blink "Ты искренне веришь, что защитила Серену по своей прихоти. Как будто это ничего для тебя не значило."

# game/script_day2.rpy:3632
translate russian d2a3_library_cece_hearttoheart_928d25df:
    ...
    C thinking "Я имею в виду, опять же, это не самое яркое воспоминание о начальной школе, и тем более не самое счастливое."

# game/script_day2.rpy:3633
translate russian d2a3_library_cece_hearttoheart_b2f22eda:
    ...
    Y default "Но ты поняла, что было важнее всего для Серены, для девочки, которая даже не была твоей подругой."
...
translate russian d2a3_library_cece_hearttoheart_ee38959c:
    ...
    Y thinking "И, учитывая эту информацию, что ты сделала? Ты выбрала хранить этот секрет больше десяти лет."

# game/script_day2.rpy:3635
translate russian d2a3_library_cece_hearttoheart_38083982_2:

    # C surprised "....."
    C surprised "....."

# game/script_day2.rpy:3636
translate russian d2a3_library_cece_hearttoheart_6576b0f3:
    ...
    Y relaxed "Конечно, может, ты не не думаешь, что эти вещи как-то связаны, но любой с малейшим чувством человечности скажет тебе..."

# game/script_day2.rpy:3637
...
translate russian d2a3_library_cece_hearttoheart_dfcc4a68:
    ...
    C blink "Хи-хи... Ничего. Просто... интересно, что сейчас ты выбрала слово \"человечность\"..."

# game/script_day2.rpy:3649
translate russian d2a3_library_cece_hearttoheart_260d4b4d:

    # Y worried "I...don't understand..." with hpunch
    Y worried "Я...не понимаю..." with hpunch

# game/script_day2.rpy:3650
translate russian d2a3_library_cece_hearttoheart_60895297:

    # C wink "You don't have to just yet, [name_player]."
    C wink "Тебе пока не обязательно это понимать, [name_player]."
...
translate russian d2a3_library_cece_hearttoheart_dedada17:
    ...
    C blush "Но спасибо. Я рада, что мы смогли поговорить."
...
translate russian d2a3_library_cece_hearttoheart_c4618bf2:
    ...
    I "Сеси... Может быть, у тебя не самый позитивный опыт в коммуникации с людьми..."

# game/script_day2.rpy:3659
...
translate russian day2_end_5e395124:
    ...
    S "Продолжение [t_clue]убийственной игры[t_cluee] для [name_player] в {color=#fff}Части III{/color}.{w=1.0}\nПожалуйста, не забывайте регулярно сохранять свой прогресс."
