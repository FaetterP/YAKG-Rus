...
translate russian d3a2_dog_confirm_end_0abee896:
    ...
    I "...Я достаточно осмотрела тело [name_dog]...?{nw}"
...
translate russian d3a2_dog_confirm_end_ff8e9ad8:
    ...
    I "...Да, этого достаточно. Теперь мне нужно помочь Сеси найти того зомби."
...
translate russian d3a2_dog_confirm_end_ec177a8d:
    ...
    I "Нет, возможно, я что-то упустила..." with hpunch
...
translate russian d3a2_dog_check_neck_953a20ee:
    ...
    I "[t_pacclue]Шея[t_paccluee] [name_dog]... Может, он умер от удушения?"
...
translate russian d3a2_dog_check_neck_a428bd52:
    ...
    I "...Подождите. Куда делся его [t_clue]ошейник[t_cluee]?" with hpunch
...
translate russian d3a2_dog_check_neck_c9f4ccc8:
    ...
    I "Я точно помню, что он был. И был достаточно жутким."
...
translate russian d3a2_dog_check_neck_f71454a8:
    ...
    I "Интересно, связано ли это с тем, как и почему он умер...?"
...
translate russian d3a2_dog_check_tail_0ccde859:
    ...
    I "[t_pacclue]Хвост[t_paccluee] [name_dog]... Кажется, я никогда не видела, чтобы он им вилял."
...
translate russian d3a2_dog_check_tail_6f3637ff:
    ...
    I "...Или нет, может, и видела? Когда он бегал вокруг, пытаясь нас запутать..."
...
translate russian d3a2_dog_check_tail_a2aff114:
    ...
    I "Он делал это, чтобы поиграть с нами? И как он вообще нас видел...?" with hpunch
...
translate russian d3a2_dog_check_pawpads_b12b1e9f:
    ...
    I "Мягкие [t_pacclue]подушечки лап[t_paccluee], от которых Рия раньше была в восторге."
...
translate russian d3a2_dog_check_pawpads_f9cd3691:
    ...
    I "Это было бы мило, если бы...обстоятельства были немного другими..."
...
translate russian d3a2_dog_check_pawpads_a6c98d02:
    ...
    I "Хмм... Не думаю, что тут есть что-то необычное..."
...
translate russian d3a2_dog_check_pawpads_b5e15c4f:
    ...
    I "...Подождите. На его задней лапе есть немного [t_clue]красных чернил[t_cluee]."
...
translate russian d3a2_dog_check_pawpads_1d2d0b31:
    ...
    I "Как они туда попали...? Не похоже, что в каждой комнате в этом доме есть красные чернила..."
...
translate russian d3a2_dog_check_back_71cc465e:
    ...
    I "Отсюда трудно разглядеть его [t_pacclue]спину[t_paccluee]... Надо посмотреть поближе..." with hpunch
...
translate russian d3a2_dog_check_back_0b77fa5a:
    ...
    I "Хмм... Нет, я не вижу ничего похожего на рану..."
...
translate russian d3a2_dog_check_back_1d02a35a:
    ...
    I "Тогда как [name_dog] умер...?" with shakeonce
...
translate russian d3a2_dog_check_head_53e0e5db:
    ...
    I "Теперь, когда я внимательно смотрю на его [t_pacclue]лицо[t_paccluee], где его глаза...? Они скрыты под его густой шерстью."
...
translate russian d3a2_dog_check_head_bebb0dc4:
    ...
    I "Это придаёт ему старческий вид.{w=1.0} ...Хм, а сколько вообще лет этой собаке...?" with hpunch
...
translate russian d3a2_dog_check_floor_6b785ca4:
    ...
    I "Может, на [t_pacclue]полу[t_paccluee] в коридоре рядом с [name_dog] есть улика..."
...
translate russian d3a2_dog_check_floor_5f7165dc:
    ...
    I "Хмм... Никаких следов, что кровь вытирали или что-то подобное..."
...
translate russian d3a2_dog_check_floor_8cec0336:
    ...
    I "Значит, велика вероятность, что тело [name_dog] [t_clue]оставили здесь после его смерти[t_cluee]..."
...
translate russian d3a2_dog_check_chest_126b71d6:
    ...
    I "[t_pacclue]Грудь[t_paccluee] [name_dog]..."
...
translate russian d3a2_dog_check_chest_42a2d44a:
    ...
    I "Да, сердцебиения нет. Никаких сомнений."
...
translate russian d3a2_dog_check_chest_7acf0655:
    ...
    I "[name_dog] [t_clue]умер[t_cluee]." with shakeonce
...
translate russian d3a2_dog_check_chest_1e78bfa4:
    ...
    I "...Но как? Я не вижу никаких ран на его груди..."
...
translate russian d3a3_corpse_confirm_end_1761a890:
    ...
    I "...Я достаточно осмотрела тело...?{nw}"
...
translate russian d3a3_corpse_confirm_end_ad0e4120:
    ...
    I "Нет... Нет, ДОЛЖНО же быть что-то, что я упустила..." with hpunch
...
translate russian d3a3_corpse_check_pockets_e400fcfd:
    ...
    I "Фу... Запах крови и... Думаю, это гниющая плоть...?" with hpunch
...
translate russian d3a3_corpse_check_pockets_790d6175:
    ...
    I "Я ничего не вижу... Ой, похоже, это что-то с [t_pacclue]карманами[t_paccluee] только с внутренней стороны."
...
translate russian d3a3_corpse_check_pockets_78c1b23b:
    ...
    Y wince "Похоже, у меня нет выбора... Нужно подойти...ургх...ближе..." with hpunch
...
translate russian d3a3_corpse_check_pockets_674369e9:
    ...
    I "Ладно, с этой стороны пусто... А с другой..." with hpunch
...
translate russian d3a3_corpse_check_pockets_1872b1a8:
    ...
    O surprised "Это наши [t_clue]телефоны[t_cluee]!" with shakeonce
...
translate russian d3a3_corpse_check_pockets_2d8e321a:
    ...
    I "Точно... Вот почему мы не могли позвать на помощь..."
...
translate russian d3a3_corpse_check_pockets_0c0a11b7:
    ...
    O thinking "Вот, это мой... Это...Сесилии, а это...должно быть, твой." with hpunch
...
translate russian d3a3_corpse_check_pockets_1ac40bc3:
    ...
    O surprised "...[name_player]? Что-то не так?{nw}"
...
translate russian d3a3_corpse_check_pockets_b97673f9:
    ...
    I "Честно говоря, кто знает, действительно ли этот телефон мой..."
...
translate russian d3a3_corpse_check_pockets_9dbd725d:
    ...
    O confused "Не волнуйся, дай я попробую позвонить-- ....."
...
translate russian d3a3_corpse_check_pockets_5f743a28:
    ...
    Y panicked "Это...действительно телефон?" with shakeonce
...
translate russian d3a3_corpse_check_pockets_e189a99c:
    ...
    O disappointed "О чём ты говоришь? Конечно, это телефон."
...
translate russian d3a3_corpse_check_pockets_e0dc81e9:
    ...
    Y thinking "Просто я думала, что телефоны... Не знаю, должны быть больше?"
...
translate russian d3a3_corpse_check_pockets_13dcd733:
    ...
    O blink "Телефоны уже десятилетиями выглядят именно так, [name_player]."
...
translate russian d3a3_corpse_check_pockets_c022ec51:
    ...
    I "Хмм... По какой-то причине мне кажется, что дело не в потере памяти..."
...
translate russian d3a3_corpse_check_pockets_e923172b:
    ...
    O confused "Ладно, дай я попробую позвонить-- ....."
...
translate russian d3a3_corpse_check_pockets_d94b1cb7:
    ...
    I "В его карманах...ничего больше нет...?" with shakeonce
...
translate russian d3a3_corpse_check_pockets_5b797baf:
    ...
    I "...Н-нет... Может, если я продолжу искать...?" with hpunch
...
translate russian d3a3_corpse_check_pockets_20cb9194:
    ...
    I "В его [t_pacclue]карманах[t_paccluee]...больше ничего нет..."
...
translate russian d3a3_corpse_check_face_c7fb03e1:
    ...
    I "Его [t_pacclue]лицо[t_paccluee] всё ещё обмотано бинтами..."
...
translate russian d3a3_corpse_check_face_6e12ebb0:
    ...
    I "Я по-прежнему уверена, что этот человек - отец этого дома, но я не смогу узнать наверняка, пока не сниму эти бинты."
...
translate russian d3a3_corpse_check_face_a8587181:
    ...
    I "...Однако сейчас я чувствую сильное давление. Думаю, мы можем взглянуть на его лицо позже." with hpunch
...
translate russian d3a3_corpse_check_knife_4bfea37c:
    ...
    I "[t_pacclue]Нож[t_paccluee] застрял у него в груди...{w=0.5} Это...{w=0.5}[t_clue]орудие убийства[t_cluee], верно?" with shakeonce
...
translate russian d3a3_corpse_check_knife_94dddaba:
    ...
    I "Если память мне не изменяет, именно с этим ножом...на нас напали в подвале..."
...
translate russian d3a3_corpse_check_knife_d5e12def:
    ...
    I "Но у него на спине тоже несколько ран... Разве это не перебор, учитывая, насколько глубокая рана у него на груди?"
...
translate russian d3a3_corpse_check_knife_28dd371e:
    ...
    I "Постойте, если так подумать, то почему нож оставили в груди? Его {i}сначала{/i} ударили в спину?" with hpunch
...
translate russian d3a3_corpse_check_knife_a68e25f4:
    ...
    I "Но...тогда это вряд ли можно назвать самообороной..."
...
translate russian d3a3_corpse_check_knife_0e81d93c:
    ...
    Y wince "...Что...здесь произошло...?" with shakeonce
...
translate russian d3a3_corpse_check_gloves_12a5a7f2:
    ...
    I "На нём черные [t_pacclue]перчатки[t_paccluee], доходящие почти до запястий."
...
translate russian d3a3_corpse_check_gloves_3efe7f7f:
    ...
    I "...Хмм? Его запястья...всегда были так открыты, верно?"
...
translate russian d3a3_corpse_check_gloves_3736025a:
    ...
    I "Если вспомнить, что было в подвале..."
...
translate russian d3a3_corpse_check_gloves_ef48650b:
    ...
    I "Да, они определённо были открыты. Странно, почему я думала иначе?"
...
translate russian d3a3_corpse_check_gloves_494fdf99:
    ...
    I "...Нет, сейчас не время летать в облаках. Мне нужно найти ключ..." with hpunch
...
translate russian d3a3_corpse_check_shoes_90630ab6:
    ...
    I "На подошвах нет крови. Это значит, что он [t_clue]не наступал в кровь[t_cluee]."
...
translate russian d3a3_corpse_check_shoes_85dddb33:
    ...
    I "Здесь...{w=0.5}нигде нет кровавых следов..." with shakeonce
...
translate russian d3a3_corpse_check_shoes_af850fae:
    ...
    I "Значит, он уже сидел, когда его ударили ножом?"
...
translate russian d3a3_corpse_check_shoes_0da0c182:
    ...
    I "Но это не имеет смысла. Почему кто-то стал бы наносить удар в грудь сидящему человеку?" with shakeonce
...
translate russian d3a3_corpse_check_back_28d6fded:
    ...
    I "На столбик кровати попало немного крови."
...
translate russian d3a3_corpse_check_back_404f0d1b:
    ...
    I "Похоже, у него уже были [t_clue]кровоточащие раны[t_cluee] на [t_pacclue]спине[t_paccluee] до того, как он упал и прислонился сюда."
...
translate russian d3a3_corpse_check_back_e5281d67:
    ...
    I "...Постойте. Это значит, что нож воткнули в его грудь только ПОСЛЕ того, как им ударили его в спину?"
...
translate russian d3a3_corpse_check_back_5ed9b71d:
    ...
    I "Зачем кому-то это делать...?" with hpunch
...
translate russian d3a3_corpse_check_hood_4acc4317:
    ...
    I "Если так подумать, то что это за [t_pacclue]капюшон[t_paccluee]?"
...
translate russian d3a3_corpse_check_hood_3cf1e255:
    ...
    I "Это явно не просто стильная одежда. По краю идут какие-то странные символы..."
...
translate russian d3a3_corpse_check_hood_3dfb32cf:
    ...
    I "...Вероятно, это как-то связано со всеми оккультными вещами в этом доме..."
...
translate russian d3a3_corpse_check_blood_4401c52a:
    ...
    I "Он сидит в луже [t_pacclue]крови[t_paccluee]..."
...
translate russian d3a3_corpse_check_blood_f223645e:
    ...
    I "Да... Кровь меня больше совсем не пугает..."
...
translate russian d3a3_corpse_check_blood_ef26804c:
    ...
    I "Постойте... И ещё, кровь есть только вокруг его тела и [t_clue]нигде больше[t_cluee]?" with shakeonce
...
translate russian d3a3_corpse_check_blood_e66ef6a3:
    ...
    I "Это значит...он уже сидел {i}до{/i} того, как был убит...?" with hpunch
...
translate russian d3a3_corpse_check_blood_e0ef48a0:
    ...
    C thinking "...[name_player]? Что случилось?"
...
translate russian d3a3_corpse_check_blood_1d8088ef:
    ...
    I "Кровь выглядит немного иначе, чем та, что я видела раньше, и она странно собрана только вокруг его тела..."

# game/script_day3_investigations.rpy:450
translate russian d3a3_corpse_check_blood_bb1c59b0:

    # I "...Maybe I'm overthinking this?"
    I "...Может, я просто накручиваю себя?"
...
translate russian d3a3_corpse_check_redpanda_b6a97e56:
    ...
    I "Рядом с телом лежит плюшевая [t_pacclue]красная панда[t_paccluee]."
...
translate russian d3a3_corpse_check_redpanda_d036dd16:
    ...
    I "Вероятно, она была свидетелем всех ужасных событий, что здесь произошли."
...
translate russian d3a3_corpse_check_redpanda_dd6dbc52:
    ...
    I "Если бы я только могла её [t_clue]допросить[t_cluee]..."
...
translate russian d3a3_corpse_check_redpanda_bd5ae2b2:
    ...
    I "...Постойте, я здесь не для того, чтобы играть в детектива. Мне следует остановиться, если я..." with hpunch
...
translate russian d3a3_corpse_check_redpanda_219f850c:
    ...
    I "Давай, сосредоточься на осмотре тела..." with shakeonce
